...
class Client(local):
    ...
    _SERVER_RETRIES = 1 # how many times to try finding a free server (if > 1, will switch freely between servers[], and MC locks become pointless)
    ...
    def _get_server(self, key):
        ...
        if self.buckets: #DAN: in case of absolutely empty servers[] list
...
class _Host(object):
    _DEAD_RETRY = 20  # (default=30) number of seconds before retrying a dead server.
    _SOCKET_TIMEOUT = 2  # (default=3) number of seconds before sockets timeout.
