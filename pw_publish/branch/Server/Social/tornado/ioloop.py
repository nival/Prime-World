    ...
    def start(self):
        ...
        try:
            while True:
                ...
                try: # PF-94987: shouldn't fail ioloop on callback-iteration exceptions (including blocking timeouts) {{{
                ...
                except Exception, e: # PF-94987
                    try:
                        logging.warning("Callback-iteration exception: %s" % e)
                    except:
                        pass # in case of logging exceptions
                # PF-94987 }}}
