...
echo -e "${green}launching person server and thrift agent...${NC}\n"
...
/etc/init.d/pw-ms start & /etc/init.d/pw-dummyps start & /etc/init.d/pw-status start & /etc/init.d/pw-cf start
