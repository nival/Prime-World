...
from SiegeInfo_base import *

class SiegeInfo(RefCounted, Identified, ChangeHandler, BaseObject, SiegeInfo_base):
    _changeFields = {
        "EndTime":1,
        "IsLocked":1,
        "Target":1,
    ...
    def generateJsonDict(self):
        json_dict = SiegeInfo_base.generateBaseDict(self)
        ...
        return {"SiegeInfo": json_dict}

if not hasattr(SiegeInfo_base, "generateBaseDict"):
    SiegeInfo_base.generateBaseDict = generateEmptyDict
