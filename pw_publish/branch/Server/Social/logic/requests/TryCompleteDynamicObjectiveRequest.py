...
class TryCompleteDynamicObjectiveRequest(BaseRequest):
    def __init__(self, modeldata, params, obfuscator=True):
        ...
        self.objective = modeldata.getDynamicObjectiveByID(objective_id)
    ...
    def parse(self):    
        if not isinstance(self.arguments, BaseRequest):
            self.arguments = TryCompleteDynamicObjectiveRequest(self.acc.model, self.arguments)
