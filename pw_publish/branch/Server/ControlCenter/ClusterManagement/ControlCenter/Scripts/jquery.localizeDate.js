...
function utcToLocal(u) {
  ...
  utcTicks += (new Date).getTimezoneOffset() * 60000 + getGlobalTicksOffcet(); // PF-86734: Все даты приводим к московской таймзоне
...
function localizeDate() {
  // PF-86734: Все даты приводим к глобальной таймзоне
