...
class SyncFolders:
    ...
    def __cmptimestamps(self, filest1, filest2):
        ...
        if file1 (source) has different creation or modification time file2 (target)
        """
        return ((filest1.st_mtime > filest2.st_mtime) or (filest1.st_ctime > filest2.st_mtime)) 
