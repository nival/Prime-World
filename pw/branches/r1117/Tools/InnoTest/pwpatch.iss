...
Filename: "{code:LauncherPath}\{#MyAppExeName}"; Description: "Start Prime World"; Flags: nowait postinstall skipifsilent 

[Code]
const UninstallRegPath = 'Software\Microsoft\Windows\CurrentVersion\Uninstall\{8A8EA42B-B6DA-49D5-A2B6-4693F1EB36D2}';
const UninstallRegPath64 = 'Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{8A8EA42B-B6DA-49D5-A2B6-4693F1EB36D2}';
