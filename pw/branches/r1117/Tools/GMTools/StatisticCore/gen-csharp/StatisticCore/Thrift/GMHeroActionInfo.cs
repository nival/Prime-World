...
namespace StatisticCore.Thrift
{
  ...
  [Serializable]
  #endif
  public partial class GMHeroActionInfo : TBase
  {
    private long _auid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("GMHeroActionInfo");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("GMHeroActionInfo(");
      sb.Append("Auid: ");
      sb.Append(Auid);
      sb.Append(",Gmlogin: ");
      sb.Append(Gmlogin);
