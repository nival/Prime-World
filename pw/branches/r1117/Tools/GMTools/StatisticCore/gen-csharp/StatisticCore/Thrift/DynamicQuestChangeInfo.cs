...
namespace StatisticCore.Thrift
{
  ...
  [Serializable]
  #endif
  public partial class DynamicQuestChangeInfo : TBase
  {
    private long _auid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("DynamicQuestChangeInfo");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("DynamicQuestChangeInfo(");
      sb.Append("Auid: ");
      sb.Append(Auid);
