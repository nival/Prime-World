...
namespace StatisticCore.Thrift
{
  ...
  [Serializable]
  #endif
  public partial class UnlockHeroInfo : TBase
  {
    private long _auid;
    private int _heroid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("UnlockHeroInfo");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("UnlockHeroInfo(");
      sb.Append("Auid: ");
      sb.Append(Auid);
      sb.Append(",Heroid: ");
      sb.Append(Heroid);
