...
namespace StatisticCore.Thrift
{
  ...
  [Serializable]
  #endif
  public partial class ResourcesChangeInfo : TBase
  {
    private long _auid;
    private bool _gain;
    private ResourceChangeItem _source;
    ...
    /// <summary>
    /// 
    /// <seealso cref="ResourceChangeItem"/>
    /// </summary>
    public ResourceChangeItem Source
    {
      get
      {
        return _source;
        ...
        switch (field.ID)
        {
          ...
          case 3:
            if (field.Type == TType.I32) {
              Source = (ResourceChangeItem)iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ResourcesChangeInfo");
      ...
      if (Buildingname != null && __isset.buildingname) {
        field.Name = "buildingname";
        field.Type = TType.String;
        field.ID = 4;
        oprot.WriteFieldBegin(field);
        oprot.WriteString(Buildingname);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("ResourcesChangeInfo(");
      sb.Append("Auid: ");
      sb.Append(Auid);
      sb.Append(",Gain: ");
      sb.Append(Gain);
