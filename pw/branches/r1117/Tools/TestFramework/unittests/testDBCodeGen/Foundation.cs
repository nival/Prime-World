...
namespace Foundation.DBSystem
{
	...
	public class AnimatedInt : AnimatedLinear<int, IntAlgorithm>
	{
		...
		public AnimatedInt( int value ) : base( value ) { }
	}
  ...
  public enum TemplateModifiable
	...
	[NoCode]
	public class TemplateModifiableProperty
	{
		public string name = string.Empty;
		public string field = string.Empty;
		public TemplateModifiable modifiable = TemplateModifiable.None;
	}
	...
	public class TemplateDefinition : DBResource
	{
		...
		public DBPtr<DBResource> templateObject;
		public List<TemplateModifiableProperty> fields = new List<TemplateModifiableProperty>();
	}
}
