...
#   define TS_TRACE(e) _TS_TRACE( __FILE__, __LINE__, e )
    ...
    // TS_OUTPUT
#   define _TS_OUTPUT(f,l,e) CxxTest::doTrace2( (f), (l), TS_AS_STRING(e) )
#   define TS_OUTPUT(e) _TS_OUTPUT( __FILE__, __LINE__, e )
...
#if defined( WIN32 )
#   define TS_FAIL(e) { _TS_FAIL( __FILE__, __LINE__, e ) ;if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); } }
#else
#   define TS_FAIL(e) { _TS_FAIL( __FILE__, __LINE__, e ) ;if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); } }
#endif

    // TS_ASSERT
#if defined( WIN32 )
#   define ___ETS_ASSERT(f,l,e,m) { if ( !(e) ) { CxxTest::doFailAssert( (f), (l), #e, (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); } } }
#else
#   define ___ETS_ASSERT(f,l,e,m) { if ( !(e) ) { CxxTest::doFailAssert( (f), (l), #e, (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); } } }
#endif
...
#   define TSM_ASSERT(m,e) _TSM_ASSERT(__FILE__,__LINE__,m,e)
    ...
    // TS_ASSERT_EQUALS
#if defined( WIN32 )
#   define ___ETS_ASSERT_EQUALS(f,l,x,y,m) { if(!CxxTest::equals( x, y )) { CxxTest::doAssertEquals( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_EQUALS(f,l,x,y,m) { if(!CxxTest::equals( x, y )) { CxxTest::doAssertEquals( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define TSM_ASSERT_EQUALS(m,x,y) _TSM_ASSERT_EQUALS(__FILE__,__LINE__,m,x,y)
    ...
    // TS_ASSERT_SAME_DATA
#if defined( WIN32 )
#   define ___ETS_ASSERT_SAME_DATA(f,l,x,y,s,m) { if(!CxxTest::sameData( (x), (y), (s) )) { CxxTest::doAssertSameData( (f), (l), #x, (x), #y, (y), #s, (s), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_SAME_DATA(f,l,x,y,s,m) { if(!CxxTest::sameData( (x), (y), (s) )) { CxxTest::doAssertSameData( (f), (l), #x, (x), #y, (y), #s, (s), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define TSM_ASSERT_SAME_DATA(m,x,y,s) _TSM_ASSERT_SAME_DATA(__FILE__,__LINE__,m,x,y,s)
    ...
    // TS_ASSERT_DIFFERS
#if defined( WIN32 )
#   define ___ETS_ASSERT_DIFFERS(f,l,x,y,m) { if(!CxxTest::differs( (x), (y) )) { CxxTest::doAssertDiffers( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_DIFFERS(f,l,x,y,m) { if(!CxxTest::differs( (x), (y) )) { CxxTest::doAssertDiffers( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define TSM_ASSERT_DIFFERS(m,x,y) _TSM_ASSERT_DIFFERS(__FILE__,__LINE__,m,x,y)
    ...
    // TS_ASSERT_LESS_THAN
#   define ___ETS_ASSERT_LESS_THAN(f,l,x,y,m) { if(!CxxTest::lessThanEquals( (x), (y) )) { CxxTest::doAssertLessThan( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
...
#   define ___ETS_ASSERT_LESS_THAN_EQUALS(f,l,x,y,m) \
      { if(!CxxTest::lessThanEquals( (x), (y) )) { CxxTest::doAssertLessThanEquals( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_LESS_THAN_EQUALS(f,l,x,y,m) \
      { if(!CxxTest::lessThanEquals( (x), (y) )) { CxxTest::doAssertLessThanEquals( (f), (l), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define ___ETS_ASSERT_PREDICATE(f,l,p,x,m) \
      { if(!p( (x)) { CxxTest::doAssertPredicate( (f), (l), #p, p(), #x, (x), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_PREDICATE(f,l,p,x,m) \
      { if(!p( (x)) { CxxTest::doAssertPredicate( (f), (l), #p, p(), #x, (x), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define ___ETS_ASSERT_RELATION(f,l,r,x,y,m) \
      { if(!r( (x), (y)) { CxxTest::doAssertRelation( (f), (l), #r, r(), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_RELATION(f,l,r,x,y,m) \
      { if(!r( (x), (y)) { CxxTest::doAssertRelation( (f), (l), #r, r(), #x, (x), #y, (y), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
#   define ___ETS_ASSERT_DELTA(f,l,x,y,d,m) \
      { if(!CxxTest::delta( (x), (y), (d) )) { CxxTest::doAssertDelta( (f), (l), #x, (x), #y, (y), #d, (d), (m) ); if ( CxxTest::isDebuggerPresent() ) { DebugBreak(); return; } } }
#else
#   define ___ETS_ASSERT_DELTA(f,l,x,y,d,m) \
      { if(!CxxTest::delta( (x), (y), (d) )) { CxxTest::doAssertDelta( (f), (l), #x, (x), #y, (y), #d, (d), (m) ); if ( CxxTest::isDebuggerPresent() ) { CxxTest::DebugBreak(); return; } } }
#endif
...
typedef CxxTest::TestSuite TestCase;
