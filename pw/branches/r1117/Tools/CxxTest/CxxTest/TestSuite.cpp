...
namespace CxxTest
{
		//HACK: external test listener stuff
		static TestListener _dummyListener;
		static TestListener *_listener = 0;
		
		extern "C" __declspec( dllexport ) void __CxxSetupTestListener( CxxTest::TestListener *listener )
		{
				_listener = listener;
		}
		
    TestListener &tracker()
    {
				if ( _listener == 0 )
    ...
    //
    //TestSuite::~TestSuite() {}
    //bool TestSuite::setUp() { return true; }
    //bool TestSuite::tearDown() { return true; }
    //bool TestSuite::setUpSuite() { return true; }
    //bool TestSuite::tearDownSuite() { return true; }
