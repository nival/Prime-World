...
register('DarkMap', removeChild)
register('DarkMapPinValue', removeChild)
register('EnvMapPinValue', removeChild)
register('ShadowReciverPinValue', removeChild)
register('LightingModelPinValue', removeChild)
register('ScrollingUVPinValue', removeChild)
register('OpacityPinValue', removeChild)
register('WaterGradMap', removeChild)
register('WaterBottomPinValue', removeChild)
