...
class Visitor(object):
    ...
    def __call__(self, file_name):
        ...
        text = fh.read()
        fh.close()
        pattern = re.compile(r'[\n\t]*<%s>(.*?)</%s>' % ( samplerName, samplerName ), re.DOTALL | re.MULTILINE)
        mp = MaterialParser()
...
register('maxMipLevel', removeChild)
register('mipMapLODBias', removeChild)
register('borderColor', removeChild)
