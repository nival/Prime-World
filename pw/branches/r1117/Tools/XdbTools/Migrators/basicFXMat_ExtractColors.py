...
### Current work. ###    
def moveColor(in_tree, out_tree, out_name, sampler_field, color_name):
	out_tree[out_name] = in_tree[sampler_field][color_name]
	out_tree[out_name].name = out_name

def addFields(in_tree, out_tree):
	moveColor(in_tree, out_tree, 'Diffuse1Mul', 'Diffuse1Map', 'Multiplier')
	moveColor(in_tree, out_tree, 'Diffuse1Add', 'Diffuse1Map', 'Add')
	moveColor(in_tree, out_tree, 'Diffuse2Mul', 'Diffuse2Map', 'Multiplier')
	moveColor(in_tree, out_tree, 'Diffuse2Add', 'Diffuse2Map', 'Add')
