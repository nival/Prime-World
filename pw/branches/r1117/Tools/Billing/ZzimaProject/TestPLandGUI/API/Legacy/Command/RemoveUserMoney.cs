...
namespace ZzimaBilling.API.Legacy.Command
{
     ...
     */
    public class RemoveUserMoney : ILegacyCommand
    {
        // user name
        ...
        public RemoveUserMoney(XmlNode nd): base(nd)
        {
        }
        ...
        public override void Execute(HttpContext context)
        {
            ...
            try
            {
                ...
                User.legacyWriteOff(svc, userName, money, serviceid);
        ...
        private void buildAnnotation(XmlElement root, bool succ)
        {
            ...
            XmlElement nmoney = (XmlElement)nret.AppendChild(resp.CreateElement("money"));
