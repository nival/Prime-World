...
<xml>
  <transferUserMoney>
    ...
    <transferUser>Transfer User Name</transferUser>
    <money>Sum</money>
...
{
    public class TransferUserMoney : ILegacyCommand
    {
        ...
        public TransferUserMoney(XmlNode nd): base(nd)
        {
        }
        ...
        public void Parse(XmlNode nd)
        {
            ...
            node = nd.SelectSingleNode("./transferUser");
            if (node == null)
                throw new Exception("transferUser is empty");
            transferUser = node.InnerText;
        ...
        public override void Execute(HttpContext context)
        {
            ...
            try
            {
                ...
                User.legacyTransfer(svc, userName, transferUser, money, serviceid);
