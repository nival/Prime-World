<%@ Page Language="C#" MasterPageFile="~/AdminUI/Templates/ZzimaMasterReports.Master"
    AutoEventWireup="true" CodeBehind="Payments.aspx.cs" Inherits="ZzimaBilling.Admin.ReportsPages.Payments"
    Title="<%$ resources: AdminUI, Reports.Menu.Payments %>"
    Culture="en-GB" %>
    ...
    <asp:Panel ID="Panel1" DefaultButton="lbtnReport" runat="server">
        ...
        <table class="tableInfo">
            ...
            <tr class="filterRowHeight">
                ...
                <td valign="top">
                    <asp:Literal ID="Literal12" runat="server" Text="<%$ resources:AdminUI, Reports.Payments.PaymentSystem %>"></asp:Literal>
                </td>
                <td>
                    <table width="100%">
                        <tr>
                            <td>
                                <input id="chkGamesId" type="checkbox" enableviewstate="true" onclick="checkedAll(document.forms[0].chkGamesId.checked, '<%=chbxPaymentSystems.ClientID %>');" />
                        ...
                        <tr>
                            <td>
                                <div class="checkBoxList">
                                    <asp:CheckBoxList ID="chbxPaymentSystems" runat="server" CssClass="controls">
                                    </asp:CheckBoxList>
                                </div>
                            </td>
                        </tr>
            ...
            <tr class="filterRowHeight">
                ...
                <td>
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ resources:AdminUI, Reports.Payments.TotalAmount %>"></asp:Literal>
                </td>
                <td>
            ...
            <tr class="filterRowHeight">
                ...
                <td>
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ resources:AdminUI, Reports.Payments.TransactionsCount %>"></asp:Literal>
                </td>
                <td>
            ...
            <tr class="filterRowHeight">
                ...
                <td>
                    <asp:Literal runat="server" Text="<%$ resources:AdminUI, Reports.Payments.HideTransactions %>" />
                </td>
                <td>
                    <asp:CheckBox ID="chbxHideTransactions" runat="server" />
                </td>
            </tr>
            <tr class="filterRowHeight">
                <td>
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <uc3:GroupsParamater ID="gpGroups" runat="server" AutoPostBack="true" />
                            </td>
                        </tr>
                    </table>
                </td>
