<%@ Page Language="C#" MasterPageFile="~/AdminUI/Templates/ZzimaMasterReports.Master"
    AutoEventWireup="true" CodeBehind="GMTransactions.aspx.cs" Inherits="ZzimaBilling.Admin.ReportsPages.GMTransactions"
    Title="<%$ resources: AdminUI, Reports.Menu.GMTransactions %>" 
    Culture="en-GB" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ReportPageHolder" runat="server">
    ...
    <table class="tableInfo">
        ...
        <tr>
            ...
            <td>
                <asp:Literal ID="Literal5" runat="server" Text="<%$ resources:AdminUI, Reports.GMLogin %>"></asp:Literal>
            </td>
            <td colspan="2">
                <asp:TextBox runat="server" CssClass="editBox" ID="tbxGMLogin"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
