<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminUI/Templates/ZzimaMaster.Master"
    Inherits="ZzimaBilling.Additive.MassReplenish" CodeBehind="MassReplenish.aspx.cs" %>
        ...
        <table>
            <tr>
                ...
                <td style="width: 320px; vertical-align: top; margin-left: 30px">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblAmount" runat="server" Text="Сумма: "></asp:Label>
