...
' ============================================================================================ '
'                                                                                              '
' FMOD Ex - Visual Basic Module.    Copyright (c), Firelight Technologies Pty, Ltd. 2004-2011. '
'                                                                                              '
' ============================================================================================ '
...
Public Const FMOD_VERSION As Long = &H43405
...
Public Declare Function FMOD_System_GetCPUUsage Lib "fmodex.dll" (ByVal system As Long, ByRef Dsp As Single, ByRef Stream As Single, ByRef Geometry As Single, ByRef Update As Single, ByRef total As Single) As FMOD_RESULT
