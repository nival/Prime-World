...
#ifdef WIN32
  #define DLLEXP "C" __declspec( dllexport )
#else
  #define DLLEXP 
#endif  
...
extern DLLEXP void __CxxRegisterGlobalFixture##fixtute_class( CxxTest::GlobalFixtureList &globalFixtures )	\
{																																																															\
...
public:                                                                                                                       \
  CSuiteDescription##suite_class () { }																																												\
 ~CSuiteDescription##suite_class () { }																																												\
protected:																																																										\
	void registerTests( CxxTest::List &argTests );																																							\
};																																																														\
extern DLLEXP void __CxxRegisterTestSuite##suite_class ( CxxTest::GlobalFixtureList &globalFixtures,			\
