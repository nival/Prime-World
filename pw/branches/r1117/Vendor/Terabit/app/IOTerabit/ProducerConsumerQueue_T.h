#ifndef TERABIT_PRODUCERCONSUMERQUEUE_T_H
#define TERABIT_PRODUCERCONSUMERQUEUE_T_H
...
#undef BROADCAST_STRATEGY

/** @class ProducerConsumerQueue_T
...
public:
     ...
     */
    ProducerConsumerQueue_T (size_t low_mark  = DEFAULT_LOW_MARK, 
                size_t high_mark = DEFAULT_HIGH_MARK,
                int active_flags = READABLE |WRITABLE);

    /// Destructor
    virtual ~ProducerConsumerQueue_T ()
    {}
...
private:
    ...
    /// noncopyable class
    ProducerConsumerQueue_T (const ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION> & other);
    ProducerConsumerQueue_T& operator=(const ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION> & other);
...
inline 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::ProducerConsumerQueue_T (size_t low_mark,
                                                           size_t high_mark,
                                                           int    active_flags)
: mtx_               ()
, cond_empty_        (mtx_)
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline size_t
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::size() const
{
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline int
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::get_active_flags () const
{
    ACE_GUARD_RETURN (MUTEX, guard, mtx_, 0);
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline bool 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::is_readable () const
{
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline bool 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::is_writable () const
{
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline int
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::activate (int flags)
{
    ACE_GUARD_RETURN (MUTEX, guard, mtx_, 0);
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline int
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::deactivate(int flags)
{
    ACE_GUARD_RETURN (MUTEX, guard, mtx_, 0);
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline bool 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::pop(OBJECT & obj)
{
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline bool 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::get(OBJECT & obj,
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline void 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::notify_producer ()
{
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline bool 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::put(const OBJECT & obj, 
                                                   const ACE_Time_Value *tv)
{
    ACE_GUARD_RETURN (MUTEX, guard, mtx_, false);
...
template <class OBJECT, class CONTAINER, class MUTEX, class CONDITION>
inline void 
ProducerConsumerQueue_T <OBJECT,CONTAINER,MUTEX,CONDITION>::notify_consumer()
{
...
#endif // TERABIT_PRODUCERCONSUMERQUEUE_T_H
