#ifndef TERABIT_CHANNELACCEPTOR_H 
#define TERABIT_CHANNELACCEPTOR_H 
 ...
 *
 * Acceptor - asynchronously establish outgoing connections
 * and  provides creation Channel and Procotol objects with
 * the help of ChannelManager,  and ProtocolFactory.
 *
 */
class IOTERABIT_Export ChannelAcceptor : public BaseAcceptor
{
public:
    ChannelAcceptor (IOThreadPool &     task,
                     ProtocolFactory &  protocol_factory, 
                     ChannelManager &   manager);

    virtual ~ChannelAcceptor (void);
...
#endif // TERABIT_CHANNELACCEPTOR_H 
