 ...
 *  @file test_config.h
 *
 *  test_config.h,v 4.111 2002/11/23 23:15:06 shuston Exp
 *
...
# define ACE_LOG_DIRECTORY ACE_TEXT ("log_win32\\")
# define MAKE_PIPE_NAME(X) ACE_TEXT ("\\\\.\\pipe\\"#X)
#else
# define ACE_LOG_DIRECTORY ACE_TEXT ("log_unix/")
