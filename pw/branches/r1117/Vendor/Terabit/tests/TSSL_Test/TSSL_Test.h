...
class Receiver : public ACE_Svc_Handler<ACE_SSL_SOCK_STREAM, ACE_MT_SYNCH>
{
...
class Acceptor : public ACE_Acceptor<Receiver,ACE_SSL_SOCK_ACCEPTOR>
{
...
class Sender : public ACE_Svc_Handler<ACE_SSL_SOCK_STREAM,ACE_MT_SYNCH>
{
...
class Connector: public ACE_Connector<Sender,ACE_SSL_SOCK_CONNECTOR>
{
  friend class Sender;
public:
