...
/*!
* gets the allow cut command.
* \type bool
* \returns Allow cut command.
*/
SkinWindow.prototype.getEnableCut = function(){
   var methodBinding = {
      "method":"getEnableCut"
   };
   return Interop.invoke(this.instanceId, methodBinding);
...
/*!
* sets the allow cut command.
* \tparam bool value Allow cut command.
*/
SkinWindow.prototype.setEnableCut = function(value){
   var methodBinding = {
      "method":"setEnableCut", 
      "value":value
   };
...
/*!
* gets the allow copy command.
* \type bool
* \returns Allow copy command.
*/
SkinWindow.prototype.getEnableCopy = function(){
   var methodBinding = {
...
/*!
* sets the allow copy command.
* \tparam bool value Allow copy command.
*/
SkinWindow.prototype.setEnableCopy = function(value){
   var methodBinding = {
...
/*!
* gets the allow paste command.
* \type bool
* \returns Allow paste command.
*/
SkinWindow.prototype.getEnablePaste = function(){
   var methodBinding = {
      "method":"getEnablePaste"
   };
   return Interop.invoke(this.instanceId, methodBinding);
};

/*!
* sets the allow paste command.
* \tparam bool value Allow paste command.
*/
SkinWindow.prototype.setEnablePaste = function(value){
   var methodBinding = {
      "method":"setEnablePaste", 
      "value":value
   };
   return Interop.invoke(this.instanceId, methodBinding);
};
