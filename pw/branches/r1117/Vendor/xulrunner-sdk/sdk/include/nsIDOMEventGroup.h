/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/mozilla-1.9.1-win32-xulrunner/build/dom/public/idl/events/nsIDOMEventGroup.idl
 */
 ...
 */
  ...
  NS_SCRIPTABLE NS_IMETHOD IsSameEventGroup(nsIDOMEventGroup *other, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMEVENTGROUP \
  NS_SCRIPTABLE NS_IMETHOD IsSameEventGroup(nsIDOMEventGroup *other, PRBool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMEVENTGROUP(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsSameEventGroup(nsIDOMEventGroup *other, PRBool *_retval NS_OUTPARAM) { return _to IsSameEventGroup(other, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMEVENTGROUP(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsSameEventGroup(nsIDOMEventGroup *other, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSameEventGroup(other, _retval); } 
...
/* boolean isSameEventGroup (in nsIDOMEventGroup other); */
NS_IMETHODIMP nsDOMEventGroup::IsSameEventGroup(nsIDOMEventGroup *other, PRBool *_retval NS_OUTPARAM)
{
