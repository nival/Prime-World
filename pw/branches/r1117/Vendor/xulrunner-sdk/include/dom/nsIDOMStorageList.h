/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/mozilla-1.9.1-win32-xulrunner/build/dom/public/idl/storage/nsIDOMStorageList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMStorageList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & domain, nsIDOMStorage **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMSTORAGELIST \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & domain, nsIDOMStorage **_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSTORAGELIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & domain, nsIDOMStorage **_retval NS_OUTPARAM) { return _to NamedItem(domain, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSTORAGELIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & domain, nsIDOMStorage **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->NamedItem(domain, _retval); } 
...
/* nsIDOMStorage namedItem (in DOMString domain); */
NS_IMETHODIMP nsDOMStorageList::NamedItem(const nsAString & domain, nsIDOMStorage **_retval NS_OUTPARAM)
{
