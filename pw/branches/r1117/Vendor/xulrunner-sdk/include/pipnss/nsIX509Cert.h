/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/mozilla-1.9.1-win32-xulrunner/build/security/manager/ssl/public/nsIX509Cert.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIX509Cert : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArray(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, PRUint32 *count NS_OUTPARAM, PRUnichar ***usages NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesString(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, nsAString & usages NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIX509CERT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArray(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, PRUint32 *count NS_OUTPARAM, PRUnichar ***usages NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesString(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, nsAString & usages NS_OUTPARAM); \
...
#define NS_FORWARD_NSIX509CERT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArray(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, PRUint32 *count NS_OUTPARAM, PRUnichar ***usages NS_OUTPARAM) { return _to GetUsagesArray(ignoreOcsp, verified, count, usages); } \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesString(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, nsAString & usages NS_OUTPARAM) { return _to GetUsagesString(ignoreOcsp, verified, usages); } \
...
#define NS_FORWARD_SAFE_NSIX509CERT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArray(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, PRUint32 *count NS_OUTPARAM, PRUnichar ***usages NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUsagesArray(ignoreOcsp, verified, count, usages); } \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesString(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, nsAString & usages NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUsagesString(ignoreOcsp, verified, usages); } \
...
/* void getUsagesArray (in boolean ignoreOcsp, out PRUint32 verified, out PRUint32 count, [array, size_is (count)] out wstring usages); */
NS_IMETHODIMP nsX509Cert::GetUsagesArray(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, PRUint32 *count NS_OUTPARAM, PRUnichar ***usages NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getUsagesString (in boolean ignoreOcsp, out PRUint32 verified, out AString usages); */
NS_IMETHODIMP nsX509Cert::GetUsagesString(PRBool ignoreOcsp, PRUint32 *verified NS_OUTPARAM, nsAString & usages NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
