...
*/
typedef BOOL (CALLBACK *LPGETLOGFILE) (PEXCEPTION_POINTERS pExceptionPointers, __reserved LPVOID lpvState);
...
#define CR_INST_ENABLE_LOGGING                 0x1000000 //!< CrashSender should write log into a text file.
...
#define CR_AF_MAX_FILE_SIZE       ( (LONGLONG)( 64 * 1024 * 1024 ) )
/*! \ingroup CrashRptAPI  
