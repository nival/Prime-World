...
typedef enum _DEBUG_FLR_PARAM_TYPE {
    ...
    DEBUG_FLR_MODULE_INFO,
    DEBUG_FLR_MODULE_INFO_INDEX,
    DEBUG_FLR_MODULE_INFO_NAME,
    DEBUG_FLR_MODULE_INFO_IMAGE_NAME,
    DEBUG_FLR_MODULE_INFO_IMAGE_PATH,
    DEBUG_FLR_MODULE_INFO_CHECKSUM,
    DEBUG_FLR_MODULE_INFO_TIMESTAMP,
    DEBUG_FLR_MODULE_INFO_UNLOADED,
    DEBUG_FLR_MODULE_INFO_ON_STACK,    
    DEBUG_FLR_MODULE_INFO_FIXED_FILE_VER,   
    DEBUG_FLR_MODULE_INFO_FIXED_PROD_VER,
    DEBUG_FLR_MODULE_INFO_STRING_FILE_VER,
    DEBUG_FLR_MODULE_INFO_STRING_PROD_VER,
    DEBUG_FLR_MODULE_INFO_COMPANY_NAME,
    DEBUG_FLR_MODULE_INFO_FILE_DESCRIPTION,
    DEBUG_FLR_MODULE_INFO_INTERNAL_NAME,
    DEBUG_FLR_MODULE_INFO_ORIG_FILE_NAME,
    DEBUG_FLR_MODULE_INFO_BASE,
    DEBUG_FLR_MODULE_INFO_SIZE,
    DEBUG_FLR_MODULE_INFO_PRODUCT_NAME,
...
typedef struct _OS_INFO {
    ...
    TCHAR   Name[64];               // Short name of OS
    TCHAR   FullName[256];          // Full name of OS includeing SP, Suite, product
    TCHAR   Language[30];           // OS language
    TCHAR   BuildVersion[64];       // Build version string
    TCHAR   ServicePackString[64];  // Service pack string
} OS_INFO, *POS_INFO;
...
// Queried target build index, the build symbols dir string is returned in pData
// pQueryInfo must be null
