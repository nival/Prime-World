...
var DeltaBlue = new BenchmarkSuite('DeltaBlue', 71104, [
  new Benchmark('DeltaBlue', deltaBlue, null, null)
]);
...
public class Strength {
    ...
    // Strength constants.
    static public const REQUIRED                 = new Strength(0, "required");
    static public const STONG_PREFERRED          = new Strength(1, "strongPreferred");
    static public const PREFERRED                = new Strength(2, "preferred");
    static public const STRONG_DEFAULT           = new Strength(3, "strongDefault");
    static public const NORMAL                   = new Strength(4, "normal");
    static public const WEAK_DEFAULT             = new Strength(5, "weakDefault");
    static public const WEAKEST                  = new Strength(6, "weakest");
...
public class Constraint {
    ...
    public function inputsKnown(mark) {return false;}
...
public class UnaryConstraint extends Constraint {
    ...
    override public function inputsKnown(mark) {
        return true;
    }
...
public class Direction {
    static public const NONE         = 0;
    static public const FORWARD      = 1;
    static public const BACKWARD     = -1;
