...
echo "devenv avmplus2008.sln /clean Debug_Debugger\|x64"
devenv avmplus2008.sln /clean Debug_Debugger\|x64

echo "devenv avmplus2008.sln /rebuild Debug_Debugger\|x64 /out build.out"
devenv avmplus2008.sln /rebuild Debug_Debugger\|x64 /out build.out
res=$?
cat build.out
...
test -f x64/Debug_Debugger/avmplus_sd_64.exe || {
...
cp x64/Debug_Debugger/avmplus_sd_64.exe $buildsdir/${change}-${changeid}/$platform/${shell_debug_debugger}
