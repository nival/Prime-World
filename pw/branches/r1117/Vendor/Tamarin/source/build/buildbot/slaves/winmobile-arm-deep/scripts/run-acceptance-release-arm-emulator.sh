...
echo "message: $py ./runtests.py  --config=arm-winmobile-emulator-tvm-release-deep --notimecheck"
$py ./runtests.py  --config=arm-winmobile-emulator-tvm-release-deep --notimecheck
