...
echo "./runtests.py --vmargs=$jit --config=arm-winmobile-tvm-release-arm$jit  --threads=$test_threads --notimecheck"
./runtests.py --vmargs=$jit --config=arm-winmobile-tvm-release-arm$jit  --threads=$test_threads --notimecheck
