...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00041604;
    ...
    */
    public enum INITFLAG
    {
        ...
        SOFTWARE_REVERB_ON_FX   = 0x00000040,   /* All platforms - Apply reverb connections to the channel DSP head (after the DSP effects) instead of directly to the sound source. */
        ...
        PS3_PREFERDTS           = 0x00800000,   /* PS3 only - Prefer DTS over Dolby Digital if both are supported. Note: 8 and 6 channel LPCM is always preferred over both DTS and Dolby Digital. */
        PS3_FORCE2CHLPCM        = 0x01000000,   /* PS3 only - Force PS3 system output mode to 2 channel LPCM. */
