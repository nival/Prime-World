...
#ifndef __BROWSERINTERFACE_H_
#define __BROWSERINTERFACE_H_

#define ITF_STRINGIZE(a)  #a
#define ITF_NAME GiveBrowserInterface
#define ITF_NAME_S ITF_STRINGIZE(GiveBrowserInterface)

class IBrowserInterface
{
public:
