...
BEGIN_OBJECT_MAP(ObjectMap)
    OBJECT_ENTRY(CLSID_NivalPluginHostCtrl, nsPluginHostCtrl)
END_OBJECT_MAP()
...
/*
[ module(dll, uuid = "{5C670C1C-33A2-4B67-8D1A-CC2CF8091A0A}", 
         name = "nivalhostctrl", 
         helpstring = "ActiveIrr 1.0 Type Library",
         resource_name = "IDR_PLUGINHOSTCTRL") ]
 class CHostCtrlModule
 {
 public:
