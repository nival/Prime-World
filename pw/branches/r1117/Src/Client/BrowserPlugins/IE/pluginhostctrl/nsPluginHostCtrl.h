...
class ATL_NO_VTABLE nsPluginHostCtrl : 
	...
	public CStockPropImpl<nsPluginHostCtrl, INivalPluginHostCtrl, &IID_INivalPluginHostCtrl, &LIBID_PLUGINHOSTCTRLLib>,
  ...
  public IPersistPropertyBagImpl<nsPluginHostCtrl>,
	...
	public IProvideClassInfo2Impl<&CLSID_NivalPluginHostCtrl, &DIID__INivalPluginHostCtrlEvents, &LIBID_PLUGINHOSTCTRLLib>,
	public IPropertyNotifySinkCP<nsPluginHostCtrl>,
	public CComCoClass<nsPluginHostCtrl, &CLSID_NivalPluginHostCtrl>
{
  typedef CComControl<nsPluginHostCtrl, nsPluginHostWnd> nsControlBase; 
protected:
...
BEGIN_COM_MAP(nsPluginHostCtrl)
	COM_INTERFACE_ENTRY(INivalPluginHostCtrl)
	COM_INTERFACE_ENTRY2(IDispatch, INivalPluginHostCtrl)
...
BEGIN_MSG_MAP(nsPluginHostCtrl)
  MESSAGE_HANDLER(WM_CREATE, nsPluginHostWnd::OnCreate)
  MESSAGE_HANDLER(WM_DESTROY, nsPluginHostWnd::OnDestroy)
  MESSAGE_HANDLER(WM_CLOSE, nsPluginHostWnd::OnDestroy)
  MESSAGE_HANDLER(WM_SIZE, nsPluginHostWnd::OnSize)
  MESSAGE_HANDLER(WM_PAINT, nsPluginHostWnd::OnPaint)
  MESSAGE_HANDLER(WM_MOUSEMOVE, nsPluginHostWnd::OnMouseMove)
  MESSAGE_HANDLER(WM_LBUTTONDOWN, nsPluginHostWnd::OnLButtonDown)
  MESSAGE_HANDLER(WM_LBUTTONUP, nsPluginHostWnd::OnLButtonUp)
	CHAIN_MSG_MAP(nsControlBase)
END_MSG_MAP()
...
public:
  ...
  STDMETHOD(get_PluginVersion)(/*[out, retval]*/ BSTR *pVal);
  STDMETHOD(put_PluginVersion)(/*[in]*/ BSTR newVal);
};
