...
STDMETHODIMP nsPluginHostCtrl::get_PluginVersion(BSTR *pVal)
{
  return GetPluginVersion(pVal);
}

STDMETHODIMP nsPluginHostCtrl::put_PluginVersion(BSTR newVal)
{
  return SetPluginVersion(newVal);
}
