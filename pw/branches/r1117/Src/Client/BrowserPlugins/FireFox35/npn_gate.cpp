...
////////////////////////////////////////////////////////////
//
// Implementation of Netscape entry points (NPN_*), so called "old" interface
//
#include "npapi.h"
...
NPError NPN_PostURL(NPP instance, const char* url, const char* window, uint32_t len, const char* buf, NPBool file)
{
 ...
 {
   jref rv;
   rv = (jref)NPNFuncs.getJavaPeer(instance);
   return rv;
 }
 ...
 {
   return (NPNFuncs.getstringidentifier)?NPNFuncs.getstringidentifier(name):NULL;
 }
 ...
 {
   return (NPNFuncs.identifierisstring)?NPNFuncs.identifierisstring(identifier):false;
 }
 ...
 bool NPN_Evaluate(NPP npp, NPObject* obj, NPString *script,
                   NPVariant *result)
 {
   return (NPNFuncs.evaluate)?NPNFuncs.evaluate(npp, obj, script, result):false;
 }
 
 bool NPN_GetProperty(NPP npp, NPObject* obj, NPIdentifier propertyName,
                      NPVariant *result)
 {
   if(NPNFuncs.getproperty){return NPNFuncs.getproperty(npp, obj, propertyName, result);}else{NULL_TO_NPVARIANT(*result); return false;}
 }
