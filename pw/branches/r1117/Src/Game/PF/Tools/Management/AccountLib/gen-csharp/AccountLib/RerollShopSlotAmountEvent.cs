...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class RerollShopSlotAmountEvent : TBase
  {
    private int _persistentId;
    private List<RerollShopSlotAmount> _slots;
    ...
    public List<RerollShopSlotAmount> Slots
    {
      get
      {
        return _slots;
    ...
    public RerollShopSlotAmountEvent() {
    }
        ...
        switch (field.ID)
        {
          ...
          case 2:
            if (field.Type == TType.List) {
              {
                Slots = new List<RerollShopSlotAmount>();
                TList _list322 = iprot.ReadListBegin();
                for( int _i323 = 0; _i323 < _list322.Count; ++_i323)
                {
                  RerollShopSlotAmount _elem324 = new RerollShopSlotAmount();
                  _elem324 = new RerollShopSlotAmount();
                  _elem324.Read(iprot);
                  Slots.Add(_elem324);
                }
                iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RerollShopSlotAmountEvent");
      ...
      if (Slots != null && __isset.slots) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (RerollShopSlotAmount _iter325 in Slots)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RerollShopSlotAmountEvent(");
