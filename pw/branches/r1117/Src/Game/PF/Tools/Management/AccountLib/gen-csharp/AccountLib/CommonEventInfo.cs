...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class CommonEventInfo : TBase
  {
    private int _persistentId;
    private ConfigEventType _type;
    ...
    public void Read (TProtocol iprot)
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 2:
            if (field.Type == TType.I32) {
              Type = (ConfigEventType)iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CommonEventInfo");
