...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class RerollShopPrice : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RerollShopPrice");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RerollShopPrice(");
