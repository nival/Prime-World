...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class CustomEventByIdResponse : TBase
  {
    ...
    public CustomEventByIdResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CustomEventByIdResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CustomEventByIdResponse(");
      sb.Append("Result: ");
      sb.Append(Result);
