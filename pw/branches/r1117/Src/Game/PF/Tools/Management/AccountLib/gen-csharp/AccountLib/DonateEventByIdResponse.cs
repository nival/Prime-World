...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class DonateEventByIdResponse : TBase
  {
    ...
    public DonateEventByIdResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("DonateEventByIdResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("DonateEventByIdResponse(");
      sb.Append("Result: ");
      sb.Append(Result);
