...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class RerollShopGroupProbabilityEvent : TBase
  {
    private int _persistentId;
    private List<RerollShopGroupProbability> _groups;
    ...
    public List<RerollShopGroupProbability> Groups
    {
      get
      {
        return _groups;
    ...
    public RerollShopGroupProbabilityEvent() {
    }
        ...
        switch (field.ID)
        {
          ...
          case 2:
            if (field.Type == TType.List) {
              {
                Groups = new List<RerollShopGroupProbability>();
                TList _list286 = iprot.ReadListBegin();
                for( int _i287 = 0; _i287 < _list286.Count; ++_i287)
                {
                  RerollShopGroupProbability _elem288 = new RerollShopGroupProbability();
                  _elem288 = new RerollShopGroupProbability();
                  _elem288.Read(iprot);
                  Groups.Add(_elem288);
                }
                iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RerollShopGroupProbabilityEvent");
      ...
      if (Groups != null && __isset.groups) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (RerollShopGroupProbability _iter289 in Groups)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RerollShopGroupProbabilityEvent(");
