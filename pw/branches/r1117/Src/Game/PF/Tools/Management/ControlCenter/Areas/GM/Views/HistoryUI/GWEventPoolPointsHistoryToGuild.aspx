...
<asp:Content ID="cTitle" ContentPlaceHolderID="TitleContent" runat="server">
	GWEventPoolPointsHistoryToGuild
</asp:Content>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="pagemenu" style="width: 30%; float: right; margin-right: 0px">
      <%= Html.ActionLink("Back to guild details", "Details", "Guild", new { id = Model.GuildAuid }, null)%>
    </div>
    
  
  <h3>GWEventPoolPointsHistoryToGuild: <%= Model.GuildAuid %> </h3>
  ...
  <br/>
    ...
    <div class="pager">
      ...
      <% for (int i = 1; i <= Model.TotalPages; i++) { %>
        <%= Html.ActionLink(i.ToString(), "GWEventPoolPointsHistory", "HistoryUI", new { eventIdx = Model.EventIdx, page = i }, i == Model.Page ? new { @class = "selected" } : null)%>
      <% } %>
    </div>
