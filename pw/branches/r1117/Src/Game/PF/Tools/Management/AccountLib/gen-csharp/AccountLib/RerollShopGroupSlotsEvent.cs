...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class RerollShopGroupSlotsEvent : TBase
  {
    private int _persistentId;
    private List<RerollShopGroupSlots> _groups;
    ...
    public List<RerollShopGroupSlots> Groups
    {
      get
      {
        return _groups;
    ...
    public RerollShopGroupSlotsEvent() {
    }
        ...
        switch (field.ID)
        {
          ...
          case 2:
            if (field.Type == TType.List) {
              {
                Groups = new List<RerollShopGroupSlots>();
                TList _list342 = iprot.ReadListBegin();
                for( int _i343 = 0; _i343 < _list342.Count; ++_i343)
                {
                  RerollShopGroupSlots _elem344 = new RerollShopGroupSlots();
                  _elem344 = new RerollShopGroupSlots();
                  _elem344.Read(iprot);
                  Groups.Add(_elem344);
                }
                iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RerollShopGroupSlotsEvent");
      ...
      if (Groups != null && __isset.groups) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (RerollShopGroupSlots _iter345 in Groups)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RerollShopGroupSlotsEvent(");
