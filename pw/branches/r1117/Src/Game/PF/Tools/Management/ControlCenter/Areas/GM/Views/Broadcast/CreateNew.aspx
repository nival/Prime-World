<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ControlCenter.Areas.GM.Models.BroadcastModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <% using ( Html.BeginForm()) {%>
    ...
    <div class="editor-label">
        <label class="timeZoneLabel"><%= Html.LabelFor( model => model.TimeStart )%>, utc+0</label>
    </div>
    <div class="editor-field">
    ...
    <div class="editor-label">
        <label class="timeZoneLabel"><%= Html.LabelFor( model => model.TimeFinish )%>, utc+0</label>
    </div>
    <div class="editor-field">
    ...
    <div class="editor-label">
        ...
        &nbsp;, sec (enter 0 to post message once)
    </div>
    <div class="editor-field">
    ...
    <div style="margin-top: 10px">
      <input type="submit" value="Create Message" id="submit1" />
    </div>
  <% } %>
