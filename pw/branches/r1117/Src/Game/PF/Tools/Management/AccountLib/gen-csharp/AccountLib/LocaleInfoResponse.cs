...
namespace AccountLib
{
  ...
  [Serializable]
  #endif
  public partial class LocaleInfoResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("LocaleInfoResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("LocaleInfoResponse(");
      sb.Append("Result: ");
      sb.Append(Result);
      sb.Append(",Info: ");
