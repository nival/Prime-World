#ifndef __L_ISocialLobbyNotify_H__
#define __L_ISocialLobbyNotify_H__
...
class LINotify : public rpc::ILocalEntity, public BaseObjectMT
{
  NI_DECLARE_REFCOUNT_CLASS_2(LINotify, rpc::ILocalEntity, BaseObjectMT);
public:
  LINotify():entityMap(0) {}
  LINotify(socialLobby::INotify* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ...
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("socialLobby::INotify", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0xc1877f4c; }
...
private:
  StrongMT<socialLobby::INotify> localObject;
...
#endif // __L_ISocialLobbyNotify_H__