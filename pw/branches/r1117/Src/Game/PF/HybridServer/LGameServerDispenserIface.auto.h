#ifndef __L_GameServerDispenserIface_H__
#define __L_GameServerDispenserIface_H__
...
class LIGameServerDispenser : public rpc::ILocalEntity, public BaseObjectMT
{
  NI_DECLARE_REFCOUNT_CLASS_2(LIGameServerDispenser, rpc::ILocalEntity, BaseObjectMT);
public:
  LIGameServerDispenser():entityMap(0) {}
  LIGameServerDispenser(HybridServer::IGameServerDispenser* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ...
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("HybridServer::IGameServerDispenser", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0x2a20f981; }
...
private:
  StrongMT<HybridServer::IGameServerDispenser> localObject;
...
class LIGameServerDispenserCallback : public rpc::ILocalEntity, public BaseObjectMT
{
  NI_DECLARE_REFCOUNT_CLASS_2(LIGameServerDispenserCallback, rpc::ILocalEntity, BaseObjectMT);
public:
  LIGameServerDispenserCallback():entityMap(0) {}
  LIGameServerDispenserCallback(HybridServer::IGameServerDispenserCallback* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ,   entityMap(_entityMap)
  ,   localObject(_localObject) 
  {
  ...
  bool vcall( byte method_id, rpc::MethodCall& call, rpc::MethodCallStack& stack );
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("HybridServer::IGameServerDispenserCallback", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0xcc400da8; }
...
private:
  StrongMT<HybridServer::IGameServerDispenserCallback> localObject;
  rpc::ILocalEntityFactory* factory;
  WeakMT<rpc::IEntityMap> entityMap;
  rpc::EntityId entityId;
};
...
#endif // __L_GameServerDispenserIface_H__