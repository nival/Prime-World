...
namespace Win32
{
	...
	public abstract class LZ
	{
		...
		[DllImport( "lz32" )]
		public static extern int LZCopy( HANDLE hfSource, HANDLE hfDest );

		[DllImport( "lz32" )]
		public static extern int LZInit( HANDLE hfSrc );

		[DllImport( "lz32" )]
		public static extern int LZOpenFile( string lpszFile, ref OFSTRUCT lpOf, int style );

		[DllImport( "lz32" )]
		public static extern int LZRead( HANDLE hfFile, string lpvBuf, int cbread );

		[DllImport( "lz32" )]
		public static extern int LZSeek( HANDLE hfFile, int lOffset, int nOrigin );

		[DllImport( "lz32" )]
		public static extern void LZClose( HANDLE hfFile );
	}
	...
	public abstract class WinMM
	{
		...
		[DllImport( "winmm" )]
		public static extern int DefDriverProc( int dwDriverIdentifier, HANDLE hdrvr, int uMsg, int lParam1, int lParam2 );

		[DllImport( "winmm" )]
		public static extern int DrvGetModuleHandle( HANDLE hDriver );

		[DllImport( "winmm" )]
		public static extern int GetDriverModuleHandle( HANDLE hDriver );

		[DllImport( "winmm" )]
		public static extern int OpenDriver( string szDriverName, string szSectionName, int lParam2 );

		[DllImport( "winmm" )]
		public static extern int PlaySound( string lpszName, HANDLE hModule, int dwFlags );
		...
		[DllImport( "winmm" )]
		public static extern int joySetCapture( HWND hwnd, int uID, int uPeriod, int bChanged );
		...
		[DllImport( "winmm" )]
		public static extern int mciSendString( string lpstrCommand, StringBuilder lpstrReturnString, int uReturnLength, HWND hwndCallback );

		[DllImport( "winmm" )]
		public static extern int midiConnect( HANDLE hmi, HANDLE hmo, IntPtr pReserved );

		[DllImport( "winmm" )]
		public static extern int midiDisconnect( HANDLE hmi, HANDLE hmo, IntPtr pReserved );

		[DllImport( "winmm" )]
		public static extern int midiInAddBuffer( HANDLE hMidiIn, ref MIDIHDR lpMidiInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiInClose( HANDLE hMidiIn );
		...
		[DllImport( "winmm" )]
		public static extern int midiInGetID( HANDLE hMidiIn, ref int lpuDeviceID );

		[DllImport( "winmm" )]
		public static extern int midiInGetNumDevs();

		[DllImport( "winmm" )]
		public static extern int midiInMessage( HANDLE hMidiIn, int msg, int dw1, int dw2 );

		[DllImport( "winmm" )]
		public static extern int midiInOpen( int lphMidiIn, int uDeviceID, int dwCallback, int dwInstance, int dwFlags );

		[DllImport( "winmm" )]
		public static extern int midiInPrepareHeader( HANDLE hMidiIn, ref MIDIHDR lpMidiInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiInReset( HANDLE hMidiIn );

		[DllImport( "winmm" )]
		public static extern int midiInStart( HANDLE hMidiIn );

		[DllImport( "winmm" )]
		public static extern int midiInStop( HANDLE hMidiIn );

		[DllImport( "winmm" )]
		public static extern int midiInUnprepareHeader( HANDLE hMidiIn, ref MIDIHDR lpMidiInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiOutCacheDrumPatches( HANDLE hMidiOut, int uPatch, ref int lpKeyArray, int uFlags );

		[DllImport( "winmm" )]
		public static extern int midiOutCachePatches( HANDLE hMidiOut, int uBank, ref int lpPatchArray, int uFlags );

		[DllImport( "winmm" )]
		public static extern int midiOutClose( HANDLE hMidiOut );
		...
		[DllImport( "winmm" )]
		public static extern int midiOutGetID( HANDLE hMidiOut, ref int lpuDeviceID );

		[DllImport( "winmm" )]
		public static extern int midiOutGetVolume( int uDeviceID, ref int lpdwVolume );

		[DllImport( "winmm" )]
		public static extern int midiOutLongMsg( HANDLE hMidiOut, ref MIDIHDR lpMidiOutHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiOutMessage( HANDLE hMidiOut, int msg, int dw1, int dw2 );

		[DllImport( "winmm" )]
		public static extern int midiOutOpen( int lphMidiOut, int uDeviceID, int dwCallback, int dwInstance, int dwFlags );

		[DllImport( "winmm" )]
		public static extern int midiOutPrepareHeader( HANDLE hMidiOut, ref MIDIHDR lpMidiOutHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiOutReset( HANDLE hMidiOut );

		[DllImport( "winmm" )]
		public static extern int midiOutSetVolume( int uDeviceID, int dwVolume );

		[DllImport( "winmm" )]
		public static extern int midiOutShortMsg( HANDLE hMidiOut, int dwMsg );

		[DllImport( "winmm" )]
		public static extern int midiOutUnprepareHeader( HANDLE hMidiOut, ref MIDIHDR lpMidiOutHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int midiStreamClose( HANDLE hms );

		[DllImport( "winmm" )]
		public static extern int midiStreamOpen( int phms, int puDeviceID, int cMidi, int dwCallback, int dwInstance, int fdwOpen );

		[DllImport( "winmm" )]
		public static extern int midiStreamOut( HANDLE hms, ref MIDIHDR pmh, int cbmh );

		[DllImport( "winmm" )]
		public static extern int midiStreamPause( HANDLE hms );

		[DllImport( "winmm" )]
		public static extern int midiStreamPosition( HANDLE hms, ref MMTIME lpmmt, int cbmmt );

		[DllImport( "winmm" )]
		public static extern int midiStreamProperty( HANDLE hms, Byte lppropdata, int dwProperty );

		[DllImport( "winmm" )]
		public static extern int midiStreamRestart( HANDLE hms );

		[DllImport( "winmm" )]
		public static extern int midiStreamStop( HANDLE hms );

		[DllImport( "winmm" )]
		public static extern int mixerClose( HANDLE hmx );

		[DllImport( "winmm" )]
		public static extern int mixerGetControlDetails( HANDLE hmxobj, ref MIXERCONTROLDETAILS pmxcd, int fdwDetails );

		[DllImport( "winmm" )]
		public static extern int mixerGetDevCaps( int uMxId, ref MIXERCAPS pmxcaps, int cbmxcaps );

		[DllImport( "winmm" )]
		public static extern int mixerGetID( HANDLE hmxobj, ref int pumxID, int fdwId );

		[DllImport( "winmm" )]
		public static extern int mixerGetLineControls( HANDLE hmxobj, ref MIXERLINECONTROLS pmxlc, int fdwControls );

		[DllImport( "winmm" )]
		public static extern int mixerGetLineInfo( HANDLE hmxobj, ref MIXERLINE pmxl, int fdwInfo );

		[DllImport( "winmm" )]
		public static extern int mixerGetNumDevs();

		[DllImport( "winmm" )]
		public static extern int mixerMessage( HANDLE hmx, int uMsg, int dwParam1, int dwParam2 );

		[DllImport( "winmm" )]
		public static extern int mixerOpen( int phmx, int uMxId, int dwCallback, int dwInstance, int fdwOpen );

		[DllImport( "winmm" )]
		public static extern int mixerSetControlDetails( HANDLE hmxobj, ref MIXERCONTROLDETAILS pmxcd, int fdwDetails );

		[DllImport( "winmm" )]
		public static extern int mmioAdvance( HANDLE hmmio, ref MMIOINFO lpmmioinfo, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioAscend( HANDLE hmmio, ref MMCKINFO lpck, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioClose( HANDLE hmmio, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioCreateChunk( HANDLE hmmio, ref MMCKINFO lpck, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioDescend( HANDLE hmmio, ref MMCKINFO lpck, ref MMCKINFO lpckParent, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioFlush( HANDLE hmmio, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioGetInfo( HANDLE hmmio, ref MMIOINFO lpmmioinfo, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioOpen( string szFileName, ref MMIOINFO lpmmioinfo, int dwOpenFlags );

		[DllImport( "winmm" )]
		public static extern int mmioRead( HANDLE hmmio, string pch, int cch );

		[DllImport( "winmm" )]
		public static extern int mmioRename( string szFileName, string SzNewFileName, ref MMIOINFO lpmmioinfo, int dwRenameFlags );

		[DllImport( "winmm" )]
		public static extern int mmioSeek( HANDLE hmmio, int lOffset, int iOrigin );

		[DllImport( "winmm" )]
		public static extern int mmioSendMessage( HANDLE hmmio, int uMsg, int lParam1, int lParam2 );

		[DllImport( "winmm" )]
		public static extern int mmioSetBuffer( HANDLE hmmio, string pchBuffer, int cchBuffer, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioSetInfo( HANDLE hmmio, ref MMIOINFO lpmmioinfo, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioStringToFOURCC( string sz, int uFlags );

		[DllImport( "winmm" )]
		public static extern int mmioWrite( HANDLE hmmio, string pch, int cch );
		...
		[DllImport( "winmm" )]
		public static extern int waveInAddBuffer( HANDLE hWaveIn, ref WAVEHDR lpWaveInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveInClose( HANDLE hWaveIn );
		...
		[DllImport( "winmm" )]
		public static extern int waveInGetID( HANDLE hWaveIn, ref int lpuDeviceID );

		[DllImport( "winmm" )]
		public static extern int waveInGetNumDevs();

		[DllImport( "winmm" )]
		public static extern int waveInGetPosition( HANDLE hWaveIn, ref MMTIME lpInfo, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveInMessage( HANDLE hWaveIn, int msg, int dw1, int dw2 );
		...
		[DllImport( "winmm" )]
		public static extern int waveInPrepareHeader( HANDLE hWaveIn, ref WAVEHDR lpWaveInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveInReset( HANDLE hWaveIn );

		[DllImport( "winmm" )]
		public static extern int waveInStart( HANDLE hWaveIn );

		[DllImport( "winmm" )]
		public static extern int waveInStop( HANDLE hWaveIn );

		[DllImport( "winmm" )]
		public static extern int waveInUnprepareHeader( HANDLE hWaveIn, ref WAVEHDR lpWaveInHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveOutBreakLoop( HANDLE hWaveOut );

		[DllImport( "winmm" )]
		public static extern int waveOutClose( HANDLE hWaveOut );
		...
		[DllImport( "winmm" )]
		public static extern int waveOutGetID( HANDLE hWaveOut, ref int lpuDeviceID );

		[DllImport( "winmm" )]
		public static extern int waveOutGetNumDevs();

		[DllImport( "winmm" )]
		public static extern int waveOutGetPitch( HANDLE hWaveOut, ref int lpdwPitch );

		[DllImport( "winmm" )]
		public static extern int waveOutGetPlaybackRate( HANDLE hWaveOut, ref int lpdwRate );
		...
		[DllImport( "winmm" )]
		public static extern int waveOutMessage( HANDLE hWaveOut, int msg, int dw1, int dw2 );
		...
		[DllImport( "winmm" )]
		public static extern int waveOutPause( HANDLE hWaveOut );

		[DllImport( "winmm" )]
		public static extern int waveOutPrepareHeader( HANDLE hWaveOut, ref WAVEHDR lpWaveOutHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveOutReset( HANDLE hWaveOut );

		[DllImport( "winmm" )]
		public static extern int waveOutRestart( HANDLE hWaveOut );

		[DllImport( "winmm" )]
		public static extern int waveOutSetPitch( HANDLE hWaveOut, int dwPitch );

		[DllImport( "winmm" )]
		public static extern int waveOutSetPlaybackRate( HANDLE hWaveOut, int dwRate );

		[DllImport( "winmm" )]
		public static extern int waveOutSetVolume( int uDeviceID, int dwVolume );

		[DllImport( "winmm" )]
		public static extern int waveOutUnprepareHeader( HANDLE hWaveOut, ref WAVEHDR lpWaveOutHdr, int uSize );

		[DllImport( "winmm" )]
		public static extern int waveOutWrite( HANDLE hWaveOut, ref WAVEHDR lpWaveOutHdr, int uSize );
