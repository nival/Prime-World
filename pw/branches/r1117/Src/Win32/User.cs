...
namespace Win32
{
    ...
    public static extern void OleCreatePropertyFrame(IntPtr hwndOwner, uint x, uint y,
        ...
        UInt32 cPages, IntPtr lpPageClsID,
        uint lcid, UInt32 dwReserved, int lpvReserved); 
	...
	public class User
	{
		...
		[DllImport( "user32" )]
		public static extern int GetDC( HWND hwnd );
		...
		public static int HIWORD( int param ) { return ( param >> 16 ) & 0xFFFF; }
		public static int GET_APPCOMMAND_LPARAM( int param ) { return HIWORD( param ) & ~FAPPCOMMAND_MASK; }
	}
}