...
namespace Win32
{
	...
	public struct LOCALESIGNATURE
	{
		...
		public int fsUsb2;
		public int fsUsb3;
		public int fsCsbDefault0;
		public int fsCsbDefault1;
		public int fsCsbSupported0;
		public int fsCsbSupported1;
	}
	...
	public abstract class Kernel
	{
		...
		[DllImport( "kernel32" )]
		public static extern int GetLocaleInfo( int Locale, int LCType, ref LOCALESIGNATURE lpLCData, int cchData );
		...
		[DllImport( "kernel32" )]
		public static extern int GetStringTypeW( int dwInfoType, string lpSrcStr, int cchSrc, [Out] short[] lpCharType );
		...
		static extern int MultiByteToWideChar( uint CodePage, uint dwFlags, [MarshalAs(UnmanagedType.LPArray)] Byte[] lpMultiByteStr, int cbMultiByte, [Out, MarshalAs( UnmanagedType.LPWStr )] StringBuilder lpWideCharStr, int cchWideChar );
		...
		[DllImport( "kernel32" )]
		public static extern int WideCharToMultiByte( int CodePage, uint dwFlags, [MarshalAs( UnmanagedType.LPWStr )] string lpWideCharStr, int cchWideChar, [MarshalAs( UnmanagedType.LPArray )] Byte[] lpMultiByteStr, int cbMultiByte, IntPtr lpDefaultChar, out bool lpUsedDefaultChar ); 
		...
		public const int C1_DEFINED = 0x200;
		...
		{
			return ((srtid & 0xFFFF) << 16) | (lgid & 0xFFFF);
		}

		public static int MAKELANGID( int primary, int secondary )
		{
			return ((secondary & 0xFFFF) << 10) | (primary & 0xFFFF);
		}
	}
}