...
namespace TransportLayer
{
  ...
  public:
    ProtocolHandler(Transport::MessageFactory* pMsgFactory, TL::ChannelFactory* chnlFactory, 
  ...
  private:
    ...
    TL::ConnectionManagerSP connectionMngr(naio::ConnectionContextStrongPtr const & spconn) const;

  private:
    TL::DataHandler realHandler_;
