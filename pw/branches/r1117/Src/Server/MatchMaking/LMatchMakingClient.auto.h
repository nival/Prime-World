#ifndef __L_MatchMakingClient_H__
#define __L_MatchMakingClient_H__
...
public:
  ...
  LIClient(MatchMaking::IClient* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ...
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("MatchMaking::IClient", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0x182b4caf; }
...
private:
  StrongMT<MatchMaking::IClient> localObject;
...
#endif // __L_MatchMakingClient_H__