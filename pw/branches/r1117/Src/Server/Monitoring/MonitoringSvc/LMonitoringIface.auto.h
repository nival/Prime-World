#ifndef __L_MonitoringIface_H__
#define __L_MonitoringIface_H__
...
class LIMonitor : public rpc::ILocalEntity, public BaseObjectMT
{
  NI_DECLARE_REFCOUNT_CLASS_2(LIMonitor, rpc::ILocalEntity, BaseObjectMT);
public:
  LIMonitor():entityMap(0) {}
  LIMonitor(Monitoring::IMonitor* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ...
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("Monitoring::IMonitor", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0x3a0ae99f; }
...
private:
  StrongMT<Monitoring::IMonitor> localObject;
