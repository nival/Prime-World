#ifndef __L_ChatClientIfaceCallback_H__
#define __L_ChatClientIfaceCallback_H__
...
class LIChatClientCallback : public rpc::ILocalEntity, public BaseObjectMT
{
  NI_DECLARE_REFCOUNT_CLASS_2(LIChatClientCallback, rpc::ILocalEntity, BaseObjectMT);
public:
  LIChatClientCallback():entityMap(0) {}
  LIChatClientCallback(chat::IChatClientCallback* _localObject, rpc::IEntityMap* _entityMap, rpc::ILocalEntityFactory* _factory=0)
  :   factory(_factory)
  ...
  virtual void* _Get( uint classId ) { return (classId == rpc::_GetId("chat::IChatClientCallback", rpc::GeneratedType) ) ? localObject : 0; }
  virtual uint GetClassCrc() const { return 0xfddadb45; }
...
private:
  StrongMT<chat::IChatClientCallback> localObject;
...
#endif // __L_ChatClientIfaceCallback_H__