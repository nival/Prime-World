...
#endif
float decalMaskWeight : register(c96);
...
half4 MainPass_PSMain( VS_OUTPUT In, float2 PixelPos : VPOS ) : COLOR0
{
  ...
  half mask = tex2Dlod(decalMask, float4(uv,0,0)).r;
  outputColor.a = lerp(mask, outputColor.a, decalMaskWeight);
