...
#define setuvvalue(L,heroVisualObject,x) \
...
static void unpersistthread(int ref, UnpersistInfo *upi)
{
    ...
    /* s.e.>> adjust ci->top to make lua_xmove happy. We will overwrite ci->top (and all CallInfo) anyway below */
    L2->ci->top = L2->top + stacksize;
