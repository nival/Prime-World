...
[Description( "????? ??????? ???????????? condition ? ??????????? ?? QuestCheckType" )]
...
public class Objective : libdb.ICompositeDBValue, libdb.IChangeable
{
	...
	[Description( "??????????? ?? value ? ???????? ???????? ???????. ?? ???? ????? True, ?? ??? ????????? ?????????? ??????? value ??????????, ???? ?? ????????? ???????? ? objective" )]
	...
	[Description( "???? ?? ??????? try_complete_objective, ? ?? ?? ?????????????, ?? ?????? ??? ??????" )]
...
public class ChangeHeroEnergyAction : QuestAction
{
	...
	[Description( "Increment - ????????/??????? ????????? ????????, Override - ??????????????, AsTopValue - ????????? ????? ??????(?????????, ???? ??????), AsBottomValue - ??????? ????? ????? (?????????, ???? ??????)" )]
...
public class StatisticEventCondition : QuestCondition
{
	...
	[Description( "???? true condition ?????????? 1, ????? - value ?? ??????" )]
