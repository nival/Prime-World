...
const char *CStrFormatter::Format( const long nValue )
{
	...
	_snprintf_s( szBuffer, FORMATTER_LENGTH, "%d", static_cast< int >( nValue ) );
	return szBuffer;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const char *CStrFormatter::Format( const unsigned long nValue )
{
	_snprintf_s( szBuffer, FORMATTER_LENGTH, bHexInteger ? "%08x" : "%d", static_cast< unsigned int >( nValue ) );
	return szBuffer;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const char *CStrFormatter::Format( const long long nValue ) 
{
	_snprintf_s( szBuffer, FORMATTER_LENGTH, bHexInteger ? "%016llx" : "%lld", nValue );
	return szBuffer;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const char *CStrFormatter::Format( const unsigned long long nValue ) 
{
...
{
	_snprintf_s( szBuffer, FORMATTER_LENGTH, bSciFloat ? "%e" : "%.8f", double( fValue ) );
	return szBuffer;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
