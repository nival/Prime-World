package TalantBarSelection 
{
	...
	public class SelectionTalentBar extends BaseDragObject
	{
		...
		private var levelPix:Number = 493 / (6*4);//17,8
		...
		//public var naftaEffect_mc:MovieClip;
		public var talentMask_mc:MovieClip;
		public var header_txt:TextField;
		
		private var isWaveEffectPlaying:Boolean;
		
		public var talent1_1:SelectionTalent;
		public var talent1_2:SelectionTalent;
		public var talent1_3:SelectionTalent;
		public var talent1_4:SelectionTalent;
		public var talent1_5:SelectionTalent;
		public var talent1_6:SelectionTalent;
		public var talent2_1:SelectionTalent;
		public var talent2_2:SelectionTalent;
		public var talent2_3:SelectionTalent;
		public var talent2_4:SelectionTalent;
		public var talent2_5:SelectionTalent;
		public var talent2_6:SelectionTalent;
		public var talent3_1:SelectionTalent;
		public var talent3_2:SelectionTalent;
		public var talent3_3:SelectionTalent;
		public var talent3_4:SelectionTalent;
		public var talent3_5:SelectionTalent;
		public var talent3_6:SelectionTalent;
		public var talent4_1:SelectionTalent;
		public var talent4_2:SelectionTalent;
		public var talent4_3:SelectionTalent;
		public var talent4_4:SelectionTalent;
		public var talent4_5:SelectionTalent;
		public var talent4_6:SelectionTalent;
		public var talent5_1:SelectionTalent;
		public var talent5_2:SelectionTalent;
		public var talent5_3:SelectionTalent;
		public var talent5_4:SelectionTalent;
		public var talent5_5:SelectionTalent;
		public var talent5_6:SelectionTalent;
		public var talent6_1:SelectionTalent;
		public var talent6_2:SelectionTalent;
		public var talent6_3:SelectionTalent;
		public var talent6_4:SelectionTalent;
		public var talent6_5:SelectionTalent;
		public var talent6_6:SelectionTalent;
		
		public function SelectionTalentBar() 
		{
...
//			//анимация поднятия уровня маски воды
			...
			//naftaEffect_mc.mouseEnabled = false;
			//naftaEffect_mc.mouseChildren = false;
		...
		private function GetTalent(column:int,raw:int):SelectionTalent
		{
			if (column >= 0 && raw >= 0 && column <= talentBar_arr.length / RAW && raw <= talentBar_arr.length / RAW)
			{
				return talentBar_arr[raw * RAW + column];
			}
			return null;
		}
		
		
		public function SetIcon(column:int, raw:int, path:String, isActive:Boolean, upgradeLevel:int)
		{
			var ico:SelectionTalent = GetTalent(column,raw);
			...
			ico.raw = raw;
			ico.icon = path;
			ico.IsActive = isActive;
			ico.setOnTur();
			ico.SetUpgradeLevel(upgradeLevel);
		}
		...
		private function StartLevelVisualisation():void
		{
			...
			if (currentWaterLevel == GetWaterLevel()) 
			{
		...
		{	
			var ost:uint = myLevel % 4;
			if (myLevel<maxLevel)
				return (myLevel - ost) / 4;
			
			return 5;
		}
		
		public function HeaderText(playerName:String):void 
		{
			header_txt.text = playerName;
		}
		...
		override protected function get WidthForPosition():Number 
		{
			return myBack_mc.width;
		}
	}
}
