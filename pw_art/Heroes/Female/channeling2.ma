...
//Name: channeling2.ma
//Last modified: Wed, Dec 30, 2009 05:23:05 PM
//Codeset: 1251
requires maya "2008";
...
createNode animClip -n "channeling2Source";
	setAttr ".ihi" 0;
	setAttr -s 649 ".ac";
...
createNode animCurveTA -n "animCurveTA2056";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -5.2047506862742576 23 -5.2047506862742576 
...
createNode animCurveTA -n "animCurveTA2094";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -14.368948490926961 23 -14.368948490926961 
		45 -14.368948490926961;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2097";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 7.9832676905363096 23 7.9832676905363096 
		45 7.9832676905363096;
	setAttr -s 3 ".kit[0:2]"  9 10 10;
	setAttr -s 3 ".kot[0:2]"  9 10 10;
...
createNode animCurveTA -n "animCurveTA2118";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 -0.049890907564117876 45 0;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2119";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 0.331104735441697 45 0;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2120";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 2.5389175890322209 45 0;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL724";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.082051230145298248 23 -0.046716579790326396 
		45 -0.082051230145298248;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTL -n "animCurveTL725";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.17714046443727427 13 0.19728540866057673 
		23 0.2054436652500731 35 0.18022743714442951 45 0.17714046443727427;
	setAttr -s 5 ".kit[0:4]"  3 9 10 9 10;
	setAttr -s 5 ".kot[0:4]"  3 9 10 9 10;
createNode animCurveTL -n "animCurveTL726";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.067653414295998859 13 0.029026872479278362 
		23 0.067530670862693543 35 0.13135365635173404 45 0.067653414295998859;
	setAttr -s 5 ".kit[0:4]"  1 10 9 10 10;
	setAttr -s 5 ".kot[0:4]"  1 10 9 10 10;
	setAttr -s 5 ".kix[0:4]"  0.98493683338165283 1 0.99040472507476807 
		1 0.98222559690475464;
	setAttr -s 5 ".kiy[0:4]"  -0.17291471362113953 0 0.1381976306438446 
		0.00016737740952521563 -0.18770401179790497;
	setAttr -s 5 ".kox[0:4]"  0.98493683338165283 1 0.99040472507476807 
		1 0.98222565650939941;
	setAttr -s 5 ".koy[0:4]"  -0.17291468381881714 0 0.1381976306438446 
		0.00016737740952521563 -0.18770402669906616;
...
createNode animCurveTU -n "animCurveTU1092";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.60000000000000075 23 -0.60000000000000075 
		45 -0.60000000000000075;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTU -n "animCurveTU1093";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.60000000000000075 11 1.3999999999999992 
		23 0.49999999999999933 45 -0.60000000000000075;
...
createNode animCurveTU -n "animCurveTU1097";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 1 23 1 45 1;
...
createNode animCurveTU -n "animCurveTU1099";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 10 23 10 45 10;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTL -n "animCurveTL733";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.22464769340943472 23 0.22464769340943472 
...
createNode animCurveTL -n "animCurveTL734";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.19416530018464082 23 0.19416530018464082 
...
createNode animCurveTL -n "animCurveTL735";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.47504801816095116 23 -0.47504801816095116 
...
createNode animCurveTU -n "animCurveTU1105";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 25 23 25 45 25;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2143";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 20.128361339199554 23 20.128361339199554 
...
createNode animCurveTL -n "animCurveTL740";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.19707483477738794 23 0.19707483477738794 
		45 0.19707483477738794;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL741";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.18298804813669703 23 0.18298804813669703 
		45 0.18298804813669703;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTL -n "animCurveTL745";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.44548779581875786 23 -0.44548779581875786 
		45 -0.44548779581875786;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL746";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -1.1017363685242332 23 -1.1017363685242332 
		45 -1.1017363685242332;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL747";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.058230793634686182 23 0.058230793634686182 
		45 0.058230793634686182;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2149";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -80.18151252360235 12 -59.135273179446372 
		23 -78.334882732556594 35 -119.97902589708944 45 -80.18151252360235;
	setAttr -s 5 ".kit[0:4]"  1 10 10 10 1;
	setAttr -s 5 ".kot[0:4]"  1 10 10 10 1;
	setAttr -s 5 ".kix[0:4]"  0.55775505304336548 0.99911755323410034 
		0.58535087108612061 0.99903559684753418 0.50345396995544434;
	setAttr -s 5 ".kiy[0:4]"  0.8300057053565979 0.042001735419034958 
		-0.81078004837036133 -0.043907299637794495 0.86402207612991333;
	setAttr -s 5 ".kox[0:4]"  0.55775493383407593 0.99911755323410034 
		0.58535087108612061 0.99903559684753418 0.50345408916473389;
	setAttr -s 5 ".koy[0:4]"  0.8300057053565979 0.042001735419034958 
		-0.81078004837036133 -0.043907299637794495 0.86402201652526855;
createNode animCurveTA -n "animCurveTA2150";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -31.647272749727556 12 -14.06013199598738 
		23 -23.300077274536136 35 -30.091274551944849 45 -31.647272749727556;
	setAttr -s 5 ".kit[0:4]"  3 10 1 1 3;
	setAttr -s 5 ".kot[0:4]"  3 10 1 1 3;
	setAttr -s 5 ".kix[2:4]"  0.86892098188400269 0.97520023584365845 
		1;
	setAttr -s 5 ".kiy[2:4]"  -0.49495095014572144 -0.22132441401481628 
		0;
	setAttr -s 5 ".kox[2:4]"  0.86892098188400269 0.97520023584365845 
		1;
	setAttr -s 5 ".koy[2:4]"  -0.49495089054107666 -0.2213243842124939 
		0;
createNode animCurveTA -n "animCurveTA2151";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -73.601450165891904 12 -75.968952550731501 
		23 -91.767675176429606 35 -106.2330954627522 45 -73.601450165891904;
	setAttr -s 5 ".kit[0:4]"  3 1 1 9 3;
	setAttr -s 5 ".kot[0:4]"  3 1 1 9 3;
	setAttr -s 5 ".kix[1:4]"  0.96446281671524048 0.84886139631271362 
		0.91788291931152344 1;
	setAttr -s 5 ".kiy[1:4]"  -0.26421868801116943 -0.52861553430557251 
		0.39685139060020447 0;
	setAttr -s 5 ".kox[1:4]"  0.96446281671524048 0.84886139631271362 
		0.91788291931152344 1;
	setAttr -s 5 ".koy[1:4]"  -0.26421865820884705 -0.52861559391021729 
		0.39685139060020447 0;
createNode animCurveTL -n "animCurveTL751";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.80093205667637646 23 0.58098322006746983 
		35 0.64441636464259267 45 0.80093205667637646;
	setAttr -s 4 ".kit[0:3]"  3 10 10 3;
	setAttr -s 4 ".kot[0:3]"  3 10 10 3;
createNode animCurveTL -n "animCurveTL752";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.78368084075325761 23 -0.61899338047441055 
		45 -0.78368084075325761;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTL -n "animCurveTL753";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -0.5438162719969829 12 -0.32374679045036059 
		23 -0.51769569309714147 35 -0.75402940792072504 45 -0.5438162719969829;
...
createNode animCurveTU -n "animCurveTU1120";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 2.2204460492503131e-016 23 2.2204460492503131e-016 
		45 2.2204460492503131e-016;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTU -n "animCurveTU1121";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 3.3000000000000007 23 -0.3999999999999998 
		35 2.7012018841158469 45 3.3000000000000007;
	setAttr -s 4 ".kit[0:3]"  3 10 10 10;
	setAttr -s 4 ".kot[0:3]"  3 10 10 10;
...
createNode animCurveTL -n "animCurveTL775";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.067033432403714843 23 0.067033432403714843 
...
createNode animCurveTL -n "animCurveTL776";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.16933803890603863 23 0.16933803890603863 
...
createNode animCurveTL -n "animCurveTL777";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.57509011135883603 23 0.57509011135883603 
...
createNode animCurveTA -n "animCurveTA2189";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -16.972634475184972 23 -16.972634475184972 
...
createNode animCurveTL -n "animCurveTL783";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.057044533275492443 23 -0.057044533275492443 
...
createNode animCurveTL -n "animCurveTL787";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.29593588683130934 23 -0.29593588683130934 
		45 -0.29593588683130934;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL788";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -1.1548517899191495 23 -1.1548517899191495 
		45 -1.1548517899191495;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL789";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.041901976070836622 23 0.041901976070836622 
		45 0.041901976070836622;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2195";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 84.225813496089941 12 66.668701272849191 
		23 90.005917214185956 35 123.10934246789175 45 84.225813496089941;
	setAttr -s 5 ".kit[0:4]"  1 10 10 10 1;
	setAttr -s 5 ".kot[0:4]"  1 10 10 10 1;
	setAttr -s 5 ".kix[0:4]"  0.55027115345001221 0.99145352840423584 
		0.61418873071670532 0.99066996574401855 0.57819873094558716;
	setAttr -s 5 ".kiy[0:4]"  -0.83498609066009521 0.13046042621135712 
		0.78915911912918091 -0.13628265261650085 -0.81589597463607788;
	setAttr -s 5 ".kox[0:4]"  0.55027121305465698 0.99145352840423584 
		0.61418873071670532 0.99066996574401855 0.57819861173629761;
	setAttr -s 5 ".koy[0:4]"  -0.83498603105545044 0.13046042621135712 
		0.78915911912918091 -0.13628265261650085 -0.81589609384536743;
createNode animCurveTA -n "animCurveTA2196";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 12.811756128936832 12 12.988406073773259 
		23 14.032974261944627 35 23.529319600728503 45 12.811756128936832;
	setAttr -s 5 ".kit[0:4]"  3 10 1 10 3;
	setAttr -s 5 ".kot[0:4]"  3 10 1 10 3;
	setAttr -s 5 ".kix[2:4]"  0.9941827654838562 0.99957793951034546 
		1;
	setAttr -s 5 ".kiy[2:4]"  0.10770702362060547 -0.029052656143903732 
		0;
	setAttr -s 5 ".kox[2:4]"  0.99418270587921143 0.99957793951034546 
		1;
	setAttr -s 5 ".koy[2:4]"  0.10770700871944427 -0.029052656143903732 
		0;
createNode animCurveTA -n "animCurveTA2197";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -61.186336054867091 12 -75.289598617008778 
		23 -85.724534662004444 35 -85.524933301070661 45 -61.186336054867091;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTL -n "animCurveTL793";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.57579797392243748 12 0.6839741045489095 
		23 0.83105571886951823 35 0.68646997177365132 45 0.57579797392243748;
	setAttr -s 5 ".kit[0:4]"  3 10 10 10 3;
	setAttr -s 5 ".kot[0:4]"  3 10 10 10 3;
createNode animCurveTL -n "animCurveTL794";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.52692018478674985 23 -0.84473053423763855 
		45 -0.52692018478674985;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTL -n "animCurveTL795";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.67340258782103002 12 0.40315041023217635 
		23 0.70342916220528418 35 1.0048681017167334 45 0.67340258782103002;
	setAttr -s 5 ".kit[0:4]"  9 10 9 10 10;
	setAttr -s 5 ".kot[0:4]"  9 10 9 10 10;
createNode animCurveTA -n "animCurveTA2198";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 0 45 1.0019500411180937e-016;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2199";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -7.2572745835853434 23 8.4492573737230412 
		45 -7.2572745835853452;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTA -n "animCurveTA2200";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -10.146021200877028 23 10.407343849330866 
		45 -10.146021200877028;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
...
createNode animCurveTU -n "animCurveTU1177";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 1.0000000000000002 23 1.0000000000000002 
...
createNode animCurveTA -n "animCurveTA2228";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 19.755424570419041 23 14.545702172751396 
		45 19.755424570419041;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2229";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 30.555776179250113 23 19.110600235521979 
		45 30.555776179250113;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2230";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -4.5307648019032269 23 -0.83192080707053839 
		45 -4.5307648019032269;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL799";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 1.3877787807814457e-017 23 1.3877787807814457e-017 
		45 1.3877787807814457e-017;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTL -n "animCurveTL801";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -1.1102230246251565e-016 23 -1.1102230246251565e-016 
		45 -1.1102230246251565e-016;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTU -n "animCurveTU1190";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999989 23 0.99999999999999989 
...
createNode animCurveTA -n "animCurveTA2252";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 15.50984446830266 23 -6.3895221042592896 
		45 15.50984446830266;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2253";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.82609962022170513 23 1.4495031063064492 
		45 -0.82609962022170513;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2254";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -3.7129586909471071 23 -1.7845353504203063 
		45 -3.7129586909471071;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTU -n "animCurveTU1192";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999978 23 0.99999999999999978 
...
createNode animCurveTU -n "animCurveTU1194";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999956 23 0.99999999999999956 
...
createNode animCurveTU -n "animCurveTU1198";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999967 23 0.99999999999999967 
...
createNode animCurveTA -n "animCurveTA2270";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 2.4570105470328594 23 -10.006950332467882 
		45 2.4570105470328594;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2271";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -12.409127898568453 23 -12.409127898568453 
...
createNode animCurveTA -n "animCurveTA2272";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 8.6298909566225337 23 8.6298909566225337 
...
createNode animCurveTA -n "animCurveTA2276";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 19.996033836671071 23 20.33693740949867 
		45 19.996033836671071;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2277";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -8.3016490742815758 23 -14.826892265970072 
		45 -8.3016490742815758;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2278";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 33.476074671085875 23 48.641881730594498 
		45 33.476074671085875;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTU -n "animCurveTU1205";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999933 23 0.99999999999999933 
...
createNode animCurveTA -n "animCurveTA2282";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 16.694008036823345 23 0 45 16.694008036823345;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2283";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 9.1357057888242039 23 0 45 9.1357057888242039;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2284";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 4.070301558133516 23 0 45 4.070301558133516;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTU -n "animCurveTU1220";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.99999999999999944 23 0.99999999999999944 
...
createNode animCurveTA -n "animCurveTA2312";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 3.6414866066920069 23 3.6414866066920069 
		45 3.6414866066920069;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2314";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 2.3061423329038795 23 -2.6125172286393581 
		45 2.3061423329038795;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
...
createNode animCurveTA -n "animCurveTA2318";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 7.5395085357164575 23 6.2932361373526193 
		45 7.5395085357164575;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2319";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.699206454756925 23 -0.5256872633927494 
		45 0.699206454756925;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2320";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 3.1446808950092726 23 -1.0185315827010757 
		45 3.1446808950092726;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
...
createNode animCurveTA -n "animCurveTA2324";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 5.6040586894104925 23 6.6236965540822306 
		45 5.6040586894104925;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2325";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.22607685214063342 23 -1.0368390109785237 
		45 -0.22607685214063342;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2326";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 2.6639370046245712 23 -3.2586100817985448 
		45 2.6639370046245712;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
...
createNode animCurveTA -n "animCurveTA2330";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 13.538042915223322 23 13.538042915223322 
		45 13.538042915223322;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2336";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -15.686918995322307 23 -16.015648224103014 
		45 -15.686918995322307;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2337";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 3.2128009500326637 23 -1.5741825502590265 
		45 3.2128009500326637;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTA -n "animCurveTA2338";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -10.093466639333586 23 6.1181666316572967 
		45 -10.093466639333586;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
...
createNode animCurveTA -n "animCurveTA2342";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 7.1906280218391343 23 18.495267488095905 
		45 7.1906280218391343;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2343";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 10.439977756198795 23 20.432919439323801 
		45 10.439977756198795;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2344";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.23897204907989225 23 -1.3662920222525181 
		45 0.23897204907989225;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTL -n "animCurveTL806";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 4.4408920985006262e-016 23 4.4408920985006262e-016 
		45 4.4408920985006262e-016;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2366";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 6.5887416381602044 23 16.300979330143932 
		45 6.5887416381602044;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2367";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 -2.478250484972353 45 0;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2368";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 23 -8.3919395683432221 45 0;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2372";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 10.802160318599565 23 10.802160318599565 
		45 10.802160318599565;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2373";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.18093193430354684 23 0.18093193430354684 
		45 0.18093193430354684;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTA -n "animCurveTA2374";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -5.5598653650577603 23 -5.5598653650577603 
		45 -5.5598653650577603;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA2384";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -5.2487233478977044 23 1.9560802435402349 
...
createNode animCurveTA -n "animCurveTA2385";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -19.191038692298999 23 -19.191038692298999 
...
createNode animCurveTA -n "animCurveTA2386";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 3.4639940811277468 23 3.4639940811277468 
...
createNode animCurveTA -n "animCurveTA2390";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 15.804493166945804 23 17.007916620191295 
...
createNode animCurveTA -n "animCurveTA2391";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 3.5290061766020497 23 8.739211506892623 
...
createNode animCurveTA -n "animCurveTA2392";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 55.012788276203878 23 31.893502022325858 
...
createNode animCurveTA -n "animCurveTA2396";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 14.236890325621934 23 25.998512085457822 
...
createNode animCurveTA -n "animCurveTA2397";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -1.4378573021860341 23 14.183940706929185 
...
createNode animCurveTA -n "animCurveTA2398";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 2.5194410123137181 23 11.108038299506635 
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "channeling2Source.cl" "clipLibrary1.sc[0]";
