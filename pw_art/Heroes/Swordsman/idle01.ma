...
//Last modified: Mon, Jul 17, 2006 05:48:42 PM
requires maya "6.0";
...
createNode animCurveTL -n "animCurveTL66";
	setAttr ".tan" 9;
	setAttr -s 5 ".ktv[0:4]"  0 0.028873232947846241 15 0.015875690471994188 
		35 -0.0081043932279430166 55 0.0054146326526420506 75 0.028873232947846241;
	setAttr -s 5 ".kit[0:4]"  10 9 9 9 10;
	setAttr -s 5 ".kot[0:4]"  10 9 9 9 10;
...
createNode animCurveTL -n "animCurveTL68";
	setAttr ".tan" 10;
	setAttr -s 5 ".ktv[0:4]"  0 -0.045463711799524242 15 -0.032149032855421034 
		35 -0.04854289063260242 55 -0.032149032855421034 75 -0.045463711799524242;
createNode animCurveTL -n "animCurveTL69";
	setAttr ".tan" 9;
	setAttr -s 5 ".ktv[0:4]"  0 0.027087692813105652 15 0.014090150337253603 
		35 -0.0098899333626836124 55 0.0036290925179014652 75 0.027087692813105652;
	setAttr -s 5 ".kit[0:4]"  10 9 9 9 10;
	setAttr -s 5 ".kot[0:4]"  10 9 9 9 10;
...
createNode animCurveTU -n "animCurveTU9";
	setAttr ".tan" 9;
	setAttr -s 3 ".ktv[0:2]"  0 1 35 1 75 1;
	setAttr -s 3 ".kit[2]"  10;
	setAttr -s 3 ".kot[0:2]"  5 5 10;
createNode animCurveTA -n "animCurveTA66";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -140.09137328137615 35 -138.30378020034746 
		75 -140.09137328137615;
createNode animCurveTA -n "animCurveTA67";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -41.32214986621824 35 -42.77778893149415 
		75 -41.32214986621824;
createNode animCurveTA -n "animCurveTA68";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 48.2339608204746 35 47.036519303467784 
		75 48.2339608204746;
createNode animCurveTL -n "animCurveTL73";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 0.22829510939120629 35 0.22829510939120629 
		75 0.22829510939120629;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
createNode animCurveTL -n "animCurveTL74";
	setAttr ".tan" 3;
	setAttr -s 3 ".ktv[0:2]"  0 -0.3818372728130861 35 -0.35272939787498453 
		75 -0.3818372728130861;
	setAttr -s 3 ".kit[1:2]"  10 3;
	setAttr -s 3 ".kot[1:2]"  10 3;
createNode animCurveTL -n "animCurveTL75";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -0.26678912622464734 35 -0.29974750397367012 
		75 -0.26678912622464734;
	setAttr -s 3 ".kit[0:2]"  3 10 10;
	setAttr -s 3 ".kot[0:2]"  3 10 10;
...
createNode animCurveTA -n "animCurveTA69";
	setAttr ".tan" 3;
	setAttr -s 3 ".ktv[0:2]"  0 115.39853119105926 35 113.71702337560286 
		75 115.39853119105926;
	setAttr -s 3 ".kit[1:2]"  9 3;
	setAttr -s 3 ".kot[1:2]"  9 3;
createNode animCurveTA -n "animCurveTA70";
	setAttr ".tan" 3;
	setAttr -s 3 ".ktv[0:2]"  0 -29.952315954069405 35 -29.115434085357169 
		75 -29.952315954069405;
	setAttr -s 3 ".kit[1:2]"  9 3;
	setAttr -s 3 ".kot[1:2]"  9 3;
createNode animCurveTA -n "animCurveTA71";
	setAttr ".tan" 3;
	setAttr -s 3 ".ktv[0:2]"  0 -65.818388294309344 35 -59.816948146692731 
		75 -65.818388294309344;
	setAttr -s 3 ".kit[1:2]"  1 3;
	setAttr -s 3 ".kot[1:2]"  1 3;
	setAttr -s 3 ".kix[1:2]"  1.1529576778411865 1.3333333730697632;
	setAttr -s 3 ".kiy[1:2]"  0.042469676584005356 0;
	setAttr -s 3 ".kox[1:2]"  1.3196238279342651 1.3333333730697632;
	setAttr -s 3 ".koy[1:2]"  0.048608887940645218 0;
createNode animCurveTL -n "animCurveTL76";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -0.28472365344926526 35 -0.31074424438002085 
		75 -0.28472365344926526;
	setAttr -s 3 ".kit[1:2]"  1 10;
	setAttr -s 3 ".kot[1:2]"  1 10;
	setAttr -s 3 ".kix[1:2]"  1.1345860958099365 1.3333333730697632;
	setAttr -s 3 ".kiy[1:2]"  0.0053008836694061756 0;
	setAttr -s 3 ".kox[1:2]"  1.2966690063476562 1.3333333730697632;
	setAttr -s 3 ".koy[1:2]"  0.0060581550933420658 0;
createNode animCurveTL -n "animCurveTL77";
	setAttr ".tan" 3;
	setAttr -s 3 ".ktv[0:2]"  0 -0.43669291079980133 35 -0.43669291079980133 
		75 -0.43669291079980133;
	setAttr -s 3 ".kit[1:2]"  9 3;
	setAttr -s 3 ".kot[1:2]"  9 3;
createNode animCurveTL -n "animCurveTL78";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 0.29198697373812826 35 0.27315043279985113 
		75 0.29198697373812826;
	setAttr -s 3 ".kit[1:2]"  1 10;
	setAttr -s 3 ".kot[1:2]"  1 10;
	setAttr -s 3 ".kix[1:2]"  1.1413112878799438 1.3333333730697632;
	setAttr -s 3 ".kiy[1:2]"  -0.0088834343478083611 0;
	setAttr -s 3 ".kox[1:2]"  1.3043557405471802 1.3333333730697632;
	setAttr -s 3 ".koy[1:2]"  -0.010152486152946949 0;
...
createNode animCurveTA -n "animCurveTA93";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -5.0566276381482984 35 -8.6135945883730383 
		75 -5.0566276381482984;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.083575360476970673 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  -0.0076465494930744171 0 0.062080785632133484;
	setAttr -s 3 ".kox[0:2]"  1.1502373218536377 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  -0.10523851960897446 0 0.062080785632133484;
createNode animCurveTA -n "animCurveTA94";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -17.107761286541351 35 -14.672851124216253 
		75 -17.107761286541351;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.096254788339138031 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  0.0064466414041817188 0 0;
	setAttr -s 3 ".kox[0:2]"  1.1629205942153931 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  0.077886335551738739 0 0;
createNode animCurveTA -n "animCurveTA95";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -55.761927886665404 35 -55.390123601664214 
		75 -55.761927886665404;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.086931005120277405 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  0.0011406884295865893 0 0;
	setAttr -s 3 ".kox[0:2]"  1.1535937786102295 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  0.015137187205255032 0 0;
createNode animCurveTL -n "animCurveTL97";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -0.011301811406185556 35 -0.0082271993039075425 
		75 -0.011301811406185556;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.099607102572917938 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  0.00024327551363967359 0 0;
	setAttr -s 3 ".kox[0:2]"  1.1620807647705078 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  0.0028382090386003256 0 0;
createNode animCurveTL -n "animCurveTL98";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -0.0098431871193776898 35 -0.0034403696451043618 
		75 -0.0098431871193776898;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.099533453583717346 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  0.00026071607135236263 0 0;
	setAttr -s 3 ".kox[0:2]"  1.1612265110015869 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  0.0030416955705732107 0 0;
createNode animCurveTL -n "animCurveTL99";
	setAttr ".tan" 10;
	setAttr -s 3 ".ktv[0:2]"  0 -0.0040455390558233545 35 -0.0087199311052271865 
		75 -0.0040455390558233545;
	setAttr -s 3 ".kit[0:2]"  1 10 10;
	setAttr -s 3 ".kot[0:2]"  1 10 10;
	setAttr -s 3 ".kix[0:2]"  0.099021270871162415 1.1666666269302368 
		1.3333333730697632;
	setAttr -s 3 ".kiy[0:2]"  -0.0004143499827478081 0 0;
	setAttr -s 3 ".kox[0:2]"  1.1552462577819824 1.3333333730697632 
		1.3333333730697632;
	setAttr -s 3 ".koy[0:2]"  -0.004834076389670372 0 0;
...
select -ne :ikSystem;
connectAttr "idle00Source.cl" "clipLibrary1.sc[1]";
...
connectAttr "Footman_Body_Transparency.a" "clipLibrary1.cel[1].cev[114].cevr"
		;
connectAttr "idle00Source.cl" "idle00.cl";
