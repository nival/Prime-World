...
//Name: birthB.ma
//Last modified: Wed, Dec 23, 2009 06:43:43 PM
//Codeset: 1251
requires maya "2008";
...
createNode clipLibrary -n "clipLibrary2";
	...
	setAttr ".cd[0].cim" -type "Int32Array" 166 0 1 2 3 4
		 ...
		 161 162 163 164 165 ;
createNode animClip -n "birthBSource2";
	setAttr ".ihi" 0;
	setAttr -s 145 ".ac";
...
createNode animCurveTA -n "animCurveTA1255";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -58.210811087465537 6 -80.036797706722751 
		16 17.221347278115157 26 24.342816389675072 38 12.518169506488068 50 52.707707451938056 
...
createNode animCurveTA -n "animCurveTA1260";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -26.23641467530431 6 -26.23641467530431 
		16 0 26 3.9369150859396673 38 8.1297202680918996 50 8.1297202680918996 62 3.2177042159257168 
...
createNode animCurveTA -n "animCurveTA1275";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 21.390714801681067 6 34.348190830316646 
...
createNode animCurveTA -n "animCurveTA1288";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -55.674217108036771 6 -63.430677535680054 
...
createNode animCurveTA -n "animCurveTA1289";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -6.2415831313725905 6 -7.3236803044255563 
		...
		62 12.527959794062154 74 0 90 0;
...
createNode animCurveTA -n "tank_M_backCloth_ctrl_rotateY1";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0 6 1.2729602429702929 16 1.2220378728275221 
		30 1.1076166073240397 42 0.99191642756774456 56 0.78842941743983064 72 0.42913605984574166 
		90 0;
...
createNode animCurveTA -n "tank_M_backCloth_ctrl_rotateX1";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0 6 0.96657162105612815 16 0.91361377567029856 
		30 0.84030746201242013 42 0.74278604348112365 56 0.6000868622917862 72 0.31507061803670605 
		90 0;
	setAttr -s 8 ".kit[0:7]"  10 10 9 9 9 9 9 10;
	setAttr -s 8 ".kot[0:7]"  10 10 9 9 9 9 9 10;
...
createNode animCurveTA -n "tank_M_frontCloth_ctrl_rotateZ1";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 6 -8.7602114092081749 14 10.142657246691165 
...
createNode animCurveTA -n "tank_M_frontCloth_ctrl_rotateY1";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0 6 0.00010994219542429486 14 0.001126298225948105 
		26 0.00077988172346424864 40 0.0013239182701172696 58 -0.00051234271198760868 75 
...
createNode animCurveTA -n "tank_M_frontCloth_ctrl_rotateX1";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0 6 0.0065464175822225563 14 -0.0075491048370122374 
		26 0.012513306924454808 40 -0.0096917685669503408 58 0.0036987997531891938 75 -0.0061863865896861301 
		90 0;
...
select -ne :ikSystem;
	setAttr -s 2 ".sol";
connectAttr "birthBSource2.cl" "clipLibrary2.sc[0]";
