...
//Name: happyA.ma
//Last modified: Thu, Dec 24, 2009 02:45:51 PM
//Codeset: 1251
requires maya "2008";
...
createNode clipLibrary -n "clipLibrary1";
	...
	setAttr ".cd[0].cim" -type "Int32Array" 178 0 1 2 3 4
		 ...
		 173 174 175 176 177 ;
createNode animClip -n "happyASource";
	setAttr ".ihi" 0;
...
createNode animCurveTA -n "animCurveTA416";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 46.484153693874759 5 45.718577105720072 
...
createNode animCurveTA -n "animCurveTA425";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 1.754519992899283 5 -3.3511867268748445 
		8 -13.023166362735163 12 -28.34747684907569 40 -28.34747684907569 54 1.754519992899283 
		70 1.754519992899283;
createNode animCurveTA -n "animCurveTA426";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -25.378456988571386 5 -16.25875131462648 
...
createNode animCurveTA -n "animCurveTA428";
	...
	setAttr -s 10 ".ktv[0:9]"  0 34.969087097535308 5 40.562466833095868 
		8 27.372312561935043 12 -59.366753548065745 24 -68.262720439615876 30 -69.001604050363127 
		35 -68.262720439615876 40 -56.947189922534236 54 33.828027019808161 70 34.969087097535308;
...
createNode animCurveTA -n "animCurveTA438";
	...
	setAttr -s 7 ".ktv[0:6]"  0 1.5268462968664711 5 1.5268462968664711 
		8 -0.8614647282805552 12 -6.7478057740091995 40 -6.7478057740091995 54 1.5268462968664711 
...
createNode animCurveTA -n "animCurveTA471";
	...
	setAttr -s 7 ".ktv[0:6]"  0 0 6 1.2729602429702929 16 1.2220378728275221 
		30 1.1076166073240399 42 0.99191642756774456 56 0.78842941743983064 70 0;
...
createNode animCurveTA -n "animCurveTA472";
	...
	setAttr -s 7 ".ktv[0:6]"  0 0 6 0.96657162105612815 16 0.91361377567029856 
		30 0.84030746201242013 42 0.74278604348112376 56 0.6000868622917862 70 0;
	setAttr -s 7 ".kit[0:6]"  10 10 9 9 9 9 3;
	setAttr -s 7 ".kot[0:6]"  10 10 9 9 9 9 3;
...
createNode animCurveTA -n "animCurveTA479";
	...
	setAttr -s 13 ".ktv[0:12]"  0 9.1478457292549002 3 1.1107633331029119 
		6 51.666862301405189 11 33.14328745276422 15 -1.7620903923913918 18 -13.194957348584072 
		24 36.273424235686299 33 -8.062281729411902 41 27.500308362887488 45 15.540944406703353 
		49 0.91396553409723691 58 15.734164358090496 70 9.1478457292549002;
...
createNode animCurveTA -n "animCurveTA501";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0 6 0 10 -4.4764001747492479 14 0.051416107673667187 
...
createNode animCurveTA -n "animCurveTA503";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 6 -8.7602114092081749 14 10.142657246691167 
...
createNode animCurveTA -n "animCurveTA504";
	...
	setAttr -s 7 ".ktv[0:6]"  0 0 6 0.00010994219542429486 14 0.001126298225948105 
		26 0.00077988172346424864 40 0.0013239182701172696 58 -0.00051234271198760878 70 
		0;
...
createNode animCurveTA -n "animCurveTA505";
	...
	setAttr -s 7 ".ktv[0:6]"  0 0 6 0.0065464175822225563 14 -0.0075491048370122374 
		26 0.01251330692445481 40 -0.0096917685669503408 58 0.0036987997531891938 70 0;
	setAttr -s 7 ".kit[6]"  3;
	setAttr -s 7 ".kot[6]"  3;
...
select -ne :ikSystem;
	setAttr -s 2 ".sol";
connectAttr "happyASource.cl" "clipLibrary1.sc[0]";
...
connectAttr "animCurveTA500.a" "clipLibrary1.cel[0].cev[142].cevr";
connectAttr "animCurveTA501.a" "clipLibrary1.cel[0].cev[143].cevr";
connectAttr "animCurveTA502.a" "clipLibrary1.cel[0].cev[144].cevr";
connectAttr "animCurveTA503.a" "clipLibrary1.cel[0].cev[145].cevr";
connectAttr "animCurveTA504.a" "clipLibrary1.cel[0].cev[146].cevr";
connectAttr "animCurveTA505.a" "clipLibrary1.cel[0].cev[147].cevr";
