...
//Name: attack01a.ma
//Last modified: Fri, Sep 18, 2009 03:04:27 PM
//Codeset: 1251
requires maya "2008";
...
createNode animCurveTA -n "animCurveTA1556";
	...
	setAttr -s 13 ".ktv[0:12]"  0 93.144161708979723 3 115.75785937936566 
		...
		37 170.13875085714341 39 148.0738572364375 45 93.144161708979738;
...
createNode animCurveTA -n "animCurveTA1557";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 95.049826002206416 3 173.55955899786744 
...
createNode animCurveTA -n "animCurveTA1558";
	...
	setAttr -s 13 ".ktv[0:12]"  0 1.1812364035166698 3 -11.216627280647769 
		...
		21 38.348771318179509 25 -34.823793435974146 28 -43.636652547435091 33 39.685876219529675 
...
createNode animCurveTA -n "animCurveTA1559";
	...
	setAttr -s 11 ".ktv[0:10]"  0 -24.884454396993167 2 -23.596579016535774 
		7 9.3264575368872933 10 16.827846407881136 12 28.474934488331229 14 38.524436495285912 
...
createNode animCurveTA -n "animCurveTA1566";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0.10616870005340093 4 0 7 -0.21664053470564906 
		10 0 12 -1.4385192003922338 14 -1.5989936705445664 18 -1.7051623705979673 45 0.10616870005340093;
...
createNode animCurveTA -n "animCurveTA1691";
	...
	setAttr -s 15 ".ktv[0:14]"  0 -21.716766331039956 2 -23.519484184576363 
		...
		32 -195.02597605123665 35 -195.5000259534944 40 -126.81874177882618 43 -170.64764437236573 
...
createNode animCurveTA -n "animCurveTA1712";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 8.3116042646716988 4 -18.776618753527686 
...
createNode animCurveTA -n "animCurveTA1714";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 7 28.749407870153433 14 -34.735012364285772 
		19 0 28 17.917258487418906 35 31.868209467465306 41 -8.5368363660849944 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
...
createNode animCurveTA -n "animCurveTA1715";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 7 -9.078926867098188 14 0 19 0 28 12.041400849102063 
		35 -15.308408284846029 41 -0.11550817999931891 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
...
createNode animCurveTA -n "animCurveTA1716";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 7 -8.2516854710557581 14 0 19 -31.238094222791474 
		28 64.689120404813835 35 -23.98169436732303 41 25.49240480509733 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 10 10 1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
...
createNode animCurveTA -n "animCurveTA1717";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 3 -3.6324973372045437 7 7.9651799044080427 
		19 -6.9778810419793862 28 38.339267624171733 32 7.9930820090763213 37 0 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 1 1 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 1 1 1;
...
createNode animCurveTA -n "animCurveTA1718";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 3 23.826117022222267 7 -40.889084752270641 
		19 54.486999252233304 28 -14.738595571810839 32 7.4521368403059416 37 0 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 1 1 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 1 1 1;
	setAttr -s 8 ".kix[5:7]"  1 1 1;
	setAttr -s 8 ".kiy[5:7]"  0 0 0;
...
createNode animCurveTA -n "animCurveTA1719";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 3 8.9691201730176697 7 -5.4949480295694002 
		19 10.525154263704009 28 3.5628340793294457 32 -11.492332534432624 37 0 45 0;
	setAttr -s 8 ".kit[0:7]"  3 10 10 10 10 1 1 1;
	setAttr -s 8 ".kot[0:7]"  3 10 10 10 10 1 1 1;
	setAttr -s 8 ".kix[5:7]"  1 1 1;
	setAttr -s 8 ".kiy[5:7]"  0 0 0;
...
createNode animCurveTA -n "animCurveTA1720";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 -15.715060180192133 14 -34.735012364285772 
		19 0 28 12.150465171964315 37 -13.415960576904236 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
	setAttr -s 7 ".kox[5:6]"  1 1;
	setAttr -s 7 ".koy[5:6]"  0 0;
createNode animCurveTA -n "animCurveTA1721";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 -5.0257467343755238 14 0 19 0 28 
		-1.4156976069949399 37 6.3353821616014958 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
...
createNode animCurveTA -n "animCurveTA1722";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 1.496667179814922 14 0 19 0 28 26.931394130741246 
		37 -10.347421069887197 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
...
createNode animCurveTA -n "animCurveTA1726";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 -24.66305729571998 14 -32.93723067278659 
		19 -5.2554653919842345 28 38.407379923667342 37 0.51670123653527522 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
...
createNode animCurveTA -n "animCurveTA1727";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 46.886439604713992 14 -43.707429741584306 
		19 -20.491914499583093 28 31.818244979755413 37 -39.034363849556087 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
...
createNode animCurveTA -n "animCurveTA1728";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 7 5.999339449624804 14 -1.8067538185542733 
		19 -11.366817397475021 28 -15.868074845005793 37 -5.9660636222881456 45 0;
	setAttr -s 7 ".kit[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kot[0:6]"  3 10 10 10 10 1 1;
	setAttr -s 7 ".kix[5:6]"  1 1;
	setAttr -s 7 ".kiy[5:6]"  0 0;
...
createNode animCurveTL -n "animCurveTL553";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -0.000119480405310887 3 0.22872433736737813 
		8 0.21188662250341694 11 0.14699047534381277 16 0.34062297800327807 26 0.070619211846259175 
		32 -0.012348767409705559 40 -0.022787973315939666 45 -0.000119480405310887;
...
createNode animCurveTL -n "animCurveTL554";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0.1152566135867675 3 0.12463076992189658 
		8 0.034746469816786647 11 -0.014352078635904708 16 0.094199839566411731 26 0.046149863202472677 
		32 0.027901843466510735 40 0.10403924481124539 45 0.1152566135867675;
	setAttr -s 9 ".kit[0:8]"  3 10 10 10 10 10 10 10 
		1;
	setAttr -s 9 ".kot[0:8]"  3 10 10 10 10 10 10 10 
		1;
...
createNode animCurveTL -n "animCurveTL555";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0.19515846066137013 3 0.42517678731065672 
		8 0.31360080505057653 11 0.21028802551417689 16 0.28840348277437833 26 0.17673669270414591 
		32 0.21341207513114538 40 0.18867526578040567 45 0.19515846066137013;
	setAttr -s 9 ".kit[0:8]"  3 10 10 10 10 10 10 10 
		1;
	setAttr -s 9 ".kot[0:8]"  3 10 10 10 10 10 10 10 
		1;
